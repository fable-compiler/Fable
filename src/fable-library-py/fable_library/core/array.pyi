...
class FSharpArray(MutableSequence[_T]):
    ...
    @overload
    def __init__(self, array_type: Literal["Generic"] | None = None, elements: list[object] | None = None) -> None: ...
    ...
    def initialize(
        self, py: Any, count: int, initializer: Callable[[int], Any], cons: Any | None = None
    ) -> FSharpArray[_T]: ...
    def compare_with(self, py: Any, comparer: Callable[[Any, Any], bool], other: FSharpArray[_T]) -> bool: ...
    ...
    def set_slice(self, py: Any, target: FSharpArray[_T], lower: int | None, upper: int | None) -> None: ...
    def insert_at(self, index: int, value: _T, cons: Any | None = None) -> None: ...

# Loose functions that delegate to member functions
def singleton(value: Any, cons: Any | None = None) -> FSharpArray: ...
...
def fold_back(folder: Callable[[Any, Any], Any], state: Any, array: FSharpArray) -> Any: ...
def fold_back_indexed(folder: Callable[[int, Any, Any], Any], state: Any, array: FSharpArray) -> Any: ...
...
def head(array: FSharpArray) -> Any: ...
def try_head(array: FSharpArray) -> Any | None: ...
def tail(array: FSharpArray, cons: Any | None = None) -> FSharpArray: ...
def item(index: int, array: FSharpArray) -> Any: ...
def try_item(index: int, array: FSharpArray) -> Any | None: ...
def reverse(array: FSharpArray) -> FSharpArray: ...
def initialize(
    count: int, initializer: Callable[[int], Any], array: FSharpArray, cons: Any | None = None
) -> FSharpArray: ...
