...
class FSharpArray(MutableSequence[_T]):
    ...
    def concat(self, other: FSharpArray[_T]) -> FSharpArray[_T]: ...
...
def max(array: FSharpArray[_T]) -> _T: ...
def min(array: FSharpArray[_T]) -> _T: ...
...
def concat(array1: FSharpArray[_T], array2: FSharpArray[_T]) -> FSharpArray[_T]: ...
