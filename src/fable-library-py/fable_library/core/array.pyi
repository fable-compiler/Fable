...
class FSharpArray[T](MutableSequence[T]):
    ...
    def sum_by[U](self, projection: Callable[[T], U], adder: Any) -> U: ...
    ...
    def choose[U](self, chooser: Callable[[T], U | None]) -> FSharpArray[U]: ...
...
def sum[T](array: FSharpArray[T], adder: Callable[[T, T], T]) -> T: ...
...
def contains[T](value: T, array: FSharpArray[T]) -> bool: ...
...
def sum_by[T, U](projection: Callable[[T], U], array: FSharpArray[T], adder: Any) -> U: ...
def unzip[T, U](array: FSharpArray[tuple[T, U]]) -> tuple[FSharpArray[T], FSharpArray[U]]: ...
def choose[T, U](chooser: Callable[[T], U | None], array: FSharpArray[T]) -> FSharpArray[U]: ...
def collect[T, U](
