...
from fable_library.util import IEnumerator
...
def append[T](
    array1: FSharpArray[T] | Iterable[T], array2: FSharpArray[T] | Iterable[T], cons: FSharpCons[T] | None = None
) -> FSharpArray[T]: ...
def average[T](array: FSharpArray[T] | Iterable[T], averager: IGenericAverager[T]) -> T: ...
def average_by[T, U](
    projection: Callable[[T], U], array: FSharpArray[T] | Iterable[T], averager: IGenericAverager[U]
) -> U: ...
def choose[T, U](
...
def compare_to[T](
    ...
    source1: FSharpArray[T] | Iterable[T],
    source2: FSharpArray[T] | Iterable[T],
) -> Int32: ...
def compare_with[T](
...
def equals_with[T](
    equals_func: Callable[[T, T], bool], array1: FSharpArray[T] | Iterable[T], array2: FSharpArray[T] | Iterable[T]
) -> bool: ...
...
def fold_back_indexed[T, S](folder: Callable[[Int32, T, S], S], array: FSharpArray[T] | Iterable[T], state: S) -> S: ...
...
def fold_indexed[T, S](
    folder: Callable[[Int32, Any, Any], Any], state: Any, array: FSharpArray[T] | Iterable[T]
) -> Any: ...
...
def iterate_indexed[T](action: Callable[[Int32, T], None], array: FSharpArray[T] | Iterable[T]) -> None: ...
def last[T](array: FSharpArray[T] | Iterable[T]) -> T: ...
def map[T, U](
    f: Callable[[T], U], array: FSharpArray[T] | Iterable[T], cons: FSharpCons[U] | None = None
) -> FSharpArray[U]: ...
def map2[T1, T2, U](
    f: Callable[[T1, T2], U],
    array1: FSharpArray[T1] | Iterable[T1],
...
def map_indexed[T, U](
    f: Callable[[Int32, T], U], array: FSharpArray[T] | Iterable[T], cons: FSharpCons[U] | None = None
) -> FSharpArray[U]: ...
def map_indexed2[T1, T2, U](
    f: Callable[[Int32, T1, T2], U],
    array1: FSharpArray[T1] | Iterable[T1],
...
def skip[T](
    count: SupportsInt, array: FSharpArray[T] | Iterable[T], cons: FSharpCons[T] | None = None
) -> FSharpArray[T]: ...
def skip_while[T](
...
def try_find_index[T](predicate: Callable[[T], bool], array: FSharpArray[T] | Iterable[T]) -> Int32 | None: ...
def try_find_index_back[T](predicate: Callable[[T], bool], array: FSharpArray[T] | Iterable[T]) -> Int32 | None: ...
...
def zip[T, U](
    array1: FSharpArray[T] | Iterable[T], array2: FSharpArray[U] | Iterable[U]
