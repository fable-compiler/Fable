...
class FSharpArray(MutableSequence[_T]):
    ...
    @overload
    def __init__(self, elements: list[Any] | None = None, array_type: Literal["Generic"] | None = None) -> None: ...
    ...
    def index_of(self, item: _T) -> int | None: ...
...
def index_of(array: FSharpArray[_T], item: _T) -> int | None: ...
