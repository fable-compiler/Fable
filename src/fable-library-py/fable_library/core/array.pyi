...
class FSharpArray[T](MutableSequence[T]):
    ...
    @staticmethod
    def initialize(
        count: SupportsInt, initializer: Callable[[int], T], cons: Any | None = None
    ) -> FSharpArray[T]: ...
    ...
    def compare_to(self, comparer: Callable[[T, T], SupportsInt], other: FSharpArray[T]) -> int: ...
    def compare_with(self, comparer: Callable[[T, T], SupportsInt], other: FSharpArray[T]) -> int: ...
    ...
    def find_index_back(self, predicate: Callable[[T], bool]) -> int: ...
    ...
    def fold_back_indexed[S](self, folder: Callable[[int, T, S], S], state: S) -> S: ...
    def fold_indexed(
    ...
    def map_indexed[U](self, f: Callable[[int, T], U], cons: Any | None = None) -> FSharpArray[U]: ...
    def map_indexed2[T1, T2, U](
        self,
        f: Callable[[int, T1, T2], U],
        array1: FSharpArray[T1],
        array2: FSharpArray[T2],
        cons: Any | None = None,
    ) -> FSharpArray[U]: ...
    ...
    def permute(self, f: Callable[[int], SupportsInt], array: FSharpArray[T]) -> FSharpArray[T]: ...
...
def compare_with[T](comparer: Callable[[T, T], SupportsInt], array1: Elements[T], array2: Elements[T]) -> int: ...
...
def fold_back_indexed[T, S](folder: Callable[[int, T, S], S], array: Elements[T], state: S) -> S: ...
...
def fold_indexed[T, S](folder: Callable[[int, Any, Any], Any], state: Any, array: Elements[T]) -> Any: ...
...
def initialize[T](
    count: SupportsInt, initializer: Callable[[int], T], cons: FSharpCons[T] | None = None
) -> FSharpArray[T]: ...
def insert_at[T](
...
def iterate_indexed[T](action: Callable[[int, T], None], array: Elements[T]) -> None: ...
def iterate_indexed2[T1, T2](action: Callable[[int, T1, T2], None], array1: Elements[T1], array2: Elements[T2]) -> None: ...
...
def map_indexed[T, U](
    f: Callable[[int, T], U], array: Elements[T], cons: FSharpCons[U] | None = None
) -> FSharpArray[U]: ...
def map_indexed2[T1, T2, U](
    f: Callable[[int, T1, T2], U],
    array1: Elements[T1],
...
def permute[T](f: Callable[[int], SupportsInt], array: Elements[T]) -> FSharpArray[T]: ...
...
def try_find_index[T](predicate: Callable[[T], bool], array: Elements[T]) -> int | None: ...
def try_find_index_back[T](predicate: Callable[[T], bool], array: Elements[T]) -> int | None: ...
