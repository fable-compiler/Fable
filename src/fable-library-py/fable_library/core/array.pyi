...
from typing import Any, ClassVar, Generic, Literal, Protocol, SupportsInt, TypeVar, overload
...
class FSharpArray(MutableSequence[_T]):
    ...
    @staticmethod
    def create(count: SupportsInt, value: _T) -> FSharpArray[_T]: ...
    @staticmethod
    def initialize(
        count: SupportsInt, initializer: Callable[[SupportsInt], _T], cons: Any | None = None
    ) -> FSharpArray[_T]: ...
    def insert(self, index: SupportsInt, value: Any) -> None: ...
    def map(self, f: Callable[[_T], _U], cons: Any | None = None) -> FSharpArray[_U]: ...
    def map_indexed(self, f: Callable[[SupportsInt, _T], _U], cons: Any | None = None) -> FSharpArray[_U]: ...
    def map_indexed2(
        self,
        f: Callable[[SupportsInt, _T1, _T2], _U],
    ...
    def chunk_by_size(self, size: SupportsInt) -> list[FSharpArray[_T]]: ...
    def fill(self, target_index: SupportsInt, count: SupportsInt, value: _T) -> FSharpArray[_T]: ...
    ...
    def sort_with(self, comparer: Callable[[_T, _T], SupportsInt]) -> FSharpArray[_T]: ...
    ...
    def fold_back_indexed(self, folder: Callable[[SupportsInt, _T, _S], _S], state: _S) -> _S: ...
    def fold_back2(self, folder: Callable[[_T1, _T2, _S], _S], array2: FSharpArray[_T2], state: _S) -> _S: ...
    def compare_with(self, comparer: Callable[[_T, _T], SupportsInt], other: FSharpArray[_T]) -> SupportsInt: ...
    def compare_to(self, comparer: Callable[[_T, _T], SupportsInt], other: FSharpArray[_T]) -> SupportsInt: ...
    ...
    def permute(self, f: Callable[[SupportsInt], SupportsInt], array: FSharpArray[_T]) -> FSharpArray[_T]: ...
    ...
    def windowed(self, window_size: SupportsInt) -> FSharpArray[FSharpArray[_T]]: ...
    def map_fold(
        self,
    ...
    def item(self, index: SupportsInt) -> _T: ...
    def try_item(self, index: SupportsInt) -> _T | None: ...
    def reverse(self) -> FSharpArray[_T]: ...  # type: ignore # Override returns new array instead of None
    def exists_offset(self, predicate: Callable[[Any], bool], index: SupportsInt) -> bool: ...
    ...
    def find_index(self, predicate: Callable[[_T], bool]) -> SupportsInt: ...
    def try_find(self, predicate: Callable[[_T], bool]) -> _T | None: ...
    def find_last_index(self, predicate: Callable[[_T], bool]) -> SupportsInt: ...
    def find_index_back(self, predicate: Callable[[_T], bool]) -> SupportsInt: ...
    def find_back(self, predicate: Callable[[_T], bool]) -> _T: ...
    def update_at(self, index: SupportsInt, value: _T, cons: Any | None = None) -> FSharpArray[_T]: ...
    def set_slice(self, target: FSharpArray[_T], lower: SupportsInt | None, upper: SupportsInt | None) -> None: ...
    def insert_at(self, index: SupportsInt, value: _T, cons: Any | None = None) -> None: ...
    def remove_at(self, index: SupportsInt, cons: Any | None = None) -> FSharpArray[_T]: ...
    def insert_many_at(
        self, index: SupportsInt, values: FSharpArray[_T], cons: Any | None = None
    ) -> FSharpArray[_T]: ...
    ...
    def copy_to(
        self, source_index: SupportsInt, target: FSharpArray[_T], target_index: SupportsInt, count: SupportsInt
    ) -> None: ...
    ...
    def insert_range_in_place(self, index: SupportsInt, values: Iterable[_T]) -> None: ...
    def get_sub_array(
        self, start_index: SupportsInt, count: SupportsInt, cons: FSharpCons[_T] | None = None
    ) -> FSharpArray[_T]: ...
    ...
    def remove_all_in_place(self, predicate: Callable[[_T], bool]) -> SupportsInt: ...
    def indexed(self) -> FSharpArray[tuple[SupportsInt, _T]]: ...
    def last(self) -> _T: ...
    def try_last(self) -> _T | None: ...
    def skip(self, count: SupportsInt, cons: FSharpCons[_T] | None = None) -> FSharpArray[_T]: ...
    def take(self, count: SupportsInt, cons: FSharpCons[_T] | None = None) -> FSharpArray[_T]: ...
    def truncate(self, count: SupportsInt) -> FSharpArray[_T]: ...
    def partition(
        self, f: Callable[[_T], bool], cons: FSharpCons[_T] | None = None
    ) -> tuple[FSharpArray[_T], FSharpArray[_T]]: ...
    def resize(
        self, new_size: SupportsInt, zero: _T | None = None, cons: FSharpCons[_T] | None = None
    ) -> FSharpArray[_T]: ...
    def choose(self, chooser: Callable[[_T], _U | None]) -> FSharpArray[_U]: ...
    def collect(self, mapping: Callable[[_T], FSharpArray[_U]], cons: Any | None = None) -> FSharpArray[_U]: ...
...
def chunk_by_size(chunk_size: SupportsInt, array: FSharpArray[_T]) -> FSharpArray[FSharpArray[_T]]: ...
def compare_with(
    comparer: Callable[[_T, _T], SupportsInt], array1: FSharpArray[_T], array2: FSharpArray[_T]
) -> SupportsInt: ...
def compare_to(
    comparer: Callable[[_T, _T], SupportsInt], source1: FSharpArray[_T], source2: FSharpArray[_T]
) -> SupportsInt: ...
def create(count: SupportsInt, value: _T) -> FSharpArray[_T]: ...
...
def initialize(
    count: SupportsInt, initializer: Callable[[SupportsInt], _T], cons: FSharpCons[_T] | None = None
) -> FSharpArray[_T]: ...
def insert_at(index: SupportsInt, value: _T, array: FSharpArray[_T], cons: FSharpCons[_T] | None = None) -> None: ...
def insert_many_at(
    index: SupportsInt,
    values: FSharpArray[_T] | Iterable[_T],
    array: FSharpArray[_T],
    cons: FSharpCons[_T] | None = None,
) -> FSharpArray[_T]: ...
def item(index: SupportsInt, array: FSharpArray[_T]) -> _T: ...
def iterate(action: Callable[[_T], None], array: FSharpArray[_T]) -> None: ...
def iterate_indexed(action: Callable[[SupportsInt, _T], None], array: FSharpArray[_T]) -> None: ...
...
def map_indexed(
    f: Callable[[SupportsInt, _T], _U], array: FSharpArray[_T], cons: FSharpCons[_U] | None = None
) -> FSharpArray[_U]: ...
def map_indexed2(
    f: Callable[[SupportsInt, _T1, _T2], _U],
    array1: FSharpArray[_T1],
...
def map_indexed3(
    f: Callable[[SupportsInt, _T1, _T2, _T3], _U],
    array1: FSharpArray[_T1],
    array2: FSharpArray[_T2],
    array3: FSharpArray[_T3],
    cons: FSharpCons[_U] | None = None,
...
def permute(f: Callable[[SupportsInt], SupportsInt], array: FSharpArray[_T]) -> FSharpArray[_T]: ...
...
def remove_at(index: SupportsInt, array: FSharpArray[_T], cons: FSharpCons[_T] | None = None) -> FSharpArray[_T]: ...
def remove_many_at(index: SupportsInt, count: SupportsInt, array: FSharpArray[_T]) -> FSharpArray[_T]: ...
...
def set_slice(
    target: FSharpArray[_T], lower: SupportsInt | None, upper: SupportsInt | None, array: FSharpArray[_T]
) -> None: ...
def singleton(value: _T, cons: FSharpCons[_T] | None = None) -> FSharpArray[_T]: ...
def skip(count: SupportsInt, array: FSharpArray[_T], cons: FSharpCons[_T] | None = None) -> FSharpArray[_T]: ...
...
def sort_in_place_with(compare_func: Callable[[_T, _T], SupportsInt], array: FSharpArray[_T]) -> None: ...
def sort(array: FSharpArray[_T], comparer: IComparer[_T]) -> FSharpArray[_T]: ...
def split_into(chunks: SupportsInt, array: FSharpArray[_T]) -> FSharpArray[FSharpArray[_T]]: ...
...
def take(count: SupportsInt, array: FSharpArray[_T], cons: FSharpCons[_T] | None = None) -> FSharpArray[_T]: ...
def transpose(
    array: FSharpArray[FSharpArray[_T]] | Iterable[FSharpArray[_T]], cons: FSharpCons[FSharpArray[_T]] | None = None
) -> FSharpArray[FSharpArray[_T]]: ...
def try_find_back(predicate: Callable[[_T], bool], array: FSharpArray[_T]) -> _T | None: ...
def try_find_index(predicate: Callable[[_T], bool], array: FSharpArray[_T]) -> SupportsInt | None: ...
def try_find_index_back(predicate: Callable[[_T], bool], array: FSharpArray[_T]) -> SupportsInt | None: ...
def try_head(array: FSharpArray[_T]) -> _T | None: ...
def try_item(index: SupportsInt, array: FSharpArray[_T]) -> _T | None: ...
def update_at(
    index: SupportsInt, value: _T, array: FSharpArray[_T], cons: FSharpCons[_T] | None = None
) -> FSharpArray[_T]: ...
def windowed(window_size: SupportsInt, array: FSharpArray[_T]) -> FSharpArray[FSharpArray[_T]]: ...
def copy_to(
    source: FSharpArray[_T],
    source_index: SupportsInt,
    target: FSharpArray[_T],
...
def insert_range_in_place(array: FSharpArray[_T], index: SupportsInt, values: Iterable[_T]) -> None: ...
def get_sub_array(
    array: FSharpArray[_T], start_index: SupportsInt, count: SupportsInt, cons: FSharpCons[_T] | None = None
) -> FSharpArray[_T]: ...
...
def remove_all_in_place(array: FSharpArray[_T], predicate: Callable[[_T], bool]) -> SupportsInt: ...
def resize(
    array: FSharpRef[FSharpArray[_T]], new_size: SupportsInt, zero: _T | None = None, cons: FSharpCons[_T] | None = None
) -> FSharpArray[_T]: ...
...
def indexed(array: FSharpArray[_T]) -> FSharpArray[tuple[SupportsInt, _T]]: ...
...
def truncate(count: SupportsInt, array: FSharpArray[_T]) -> FSharpArray[_T]: ...
def partition(
...
def sort_with(comparer: Callable[[_T, _T], SupportsInt], array: FSharpArray[_T]) -> FSharpArray[_T]: ...
...
def collect(
    mapping: Callable[[_T], FSharpArray[_U]], array: FSharpArray[_T], cons: FSharpCons[_U] | None = None
) -> FSharpArray[_U]: ...

class FSharpCons(Generic[_T]):
    array_type: ClassVar[str]
    def __init__(self, array_type: ArrayType) -> None: ...
    def __call__(self, length: SupportsInt) -> FSharpArray[_T]: ...
    def allocate(self, length: SupportsInt) -> FSharpArray[_T]: ...

def allocate_array_from_cons(cons: FSharpCons[_T] | None, length: SupportsInt) -> FSharpArray[_T]: ...

class IGenericAverager(Protocol[_T]):
    @property
    def GetZero(self) -> Callable[[], _T]: ...
    @property
    def Add(self) -> Callable[[_T, _T], _T]: ...
    @property
    def DivideByInt(self) -> Callable[[_T, SupportsInt], _T]: ...

class IEqualityComparer(Protocol[_T_co]):
    def Equals(self, x: _T, y: _T) -> bool: ...

class IComparer(Protocol[_T_co]):
    def Compare(self, x: _T, y: _T) -> SupportsInt: ...
