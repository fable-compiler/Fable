...
def contains[T](value: T, array: FSharpArray[T] | Iterable[T], eq: IEqualityComparer_1[T] | None = None) -> bool: ...
...
def equals_with[T](
    ...
    array1: FSharpArray[T] | Iterable[T] | None,
    array2: FSharpArray[T] | Iterable[T] | None,
) -> bool: ...
...
def max[T](array: FSharpArray[T] | Iterable[T], comparer: IComparer_1[T]) -> T: ...
def max_by[T, U](projection: Callable[[T], U], array: FSharpArray[T] | Iterable[T], comparer: IComparer_1[U]) -> T: ...
def min[T](array: FSharpArray[T] | Iterable[T], comparer: IComparer_1[T]) -> T: ...
def min_by[T, U](projection: Callable[[T], U], array: FSharpArray[T] | Iterable[T], comparer: IComparer_1[U]) -> T: ...
...
def sort[T](array: FSharpArray[T] | Iterable[T], comparer: IComparer_1[T]) -> FSharpArray[T]: ...
def sort_by[T](
    projection: Callable[[T], Any], array: FSharpArray[T] | Iterable[T], comparer: IComparer_1[T] | None = None
) -> FSharpArray[T]: ...
...
def transpose[T](
    array: FSharpArray[FSharpArray[T]] | Iterable[FSharpArray[T]], cons: FSharpCons[T] | None = None
