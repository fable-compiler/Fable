...
class FSharpArray(MutableSequence[_T]):
    ...
    @staticmethod
    def create(count: Int32, value: _T) -> FSharpArray[_T]: ...
    @staticmethod
    def initialize(count: Int32, initializer: Callable[[Int32], _T], cons: Any | None = None) -> FSharpArray[_T]: ...
    def insert(self, index: Int32, value: Any) -> None: ...
    def map(self, f: Callable[[_T], _U], cons: Any | None = None) -> FSharpArray[_U]: ...
    def map_indexed(self, f: Callable[[Int32, _T], _U], cons: Any | None = None) -> FSharpArray[_U]: ...
    def map_indexed2(
        self,
        f: Callable[[Int32, _T1, _T2], _U],
    ...
    def chunk_by_size(self, size: Int32) -> list[FSharpArray[_T]]: ...
    def fill(self, target_index: Int32, count: Int32, value: _T) -> FSharpArray[_T]: ...
    ...
    def sort_in_place_with(self, comparer: Callable[[Any, Any], Int32]) -> None: ...
    ...
    def sort_with(self, comparer: Callable[[_T, _T], Int32]) -> FSharpArray[_T]: ...
    ...
    def fold_back_indexed(self, folder: Callable[[Int32, _T, _S], _S], state: _S) -> _S: ...
    def fold_back2(self, folder: Callable[[_T1, _T2, _S], _S], array2: FSharpArray[_T2], state: _S) -> _S: ...
    def compare_with(self, comparer: Callable[[_T, _T], Int32], other: FSharpArray[_T]) -> Int32: ...
    def compare_to(self, comparer: Callable[[_T, _T], Int32], other: FSharpArray[_T]) -> Int32: ...
    ...
    def permute(self, f: Callable[[Int32], Int32], array: FSharpArray[_T]) -> FSharpArray[_T]: ...
    ...
    def try_find_index_back(self, predicate: Callable[[Any], bool]) -> Int32: ...
    def try_find_index(self, predicate: Callable[[Any], bool]) -> Int32 | None: ...
    def windowed(self, window_size: Int32) -> FSharpArray[FSharpArray[_T]]: ...
    def map_fold(
        self,
    ...
    def item(self, index: Int32) -> _T: ...
    def try_item(self, index: Int32) -> _T | None: ...
    def reverse(self) -> FSharpArray[_T]: ...  # type: ignore # Override returns new array instead of None
    def exists_offset(self, predicate: Callable[[Any], bool], index: Int32) -> bool: ...
    ...
    def find_index(self, predicate: Callable[[_T], bool]) -> Int32: ...
    def try_find(self, predicate: Callable[[_T], bool]) -> _T | None: ...
    def find_last_index(self, predicate: Callable[[_T], bool]) -> Int32: ...
    def find_index_back(self, predicate: Callable[[_T], bool]) -> Int32: ...
    def find_back(self, predicate: Callable[[_T], bool]) -> _T: ...
    def update_at(self, index: Int32, value: _T, cons: Any | None = None) -> FSharpArray[_T]: ...
    def set_slice(self, target: FSharpArray[_T], lower: Int32 | None, upper: Int32 | None) -> None: ...
    def insert_at(self, index: Int32, value: _T, cons: Any | None = None) -> None: ...
    def remove_at(self, index: Int32, cons: Any | None = None) -> FSharpArray[_T]: ...
    def insert_many_at(self, index: Int32, values: FSharpArray[_T], cons: Any | None = None) -> FSharpArray[_T]: ...
    def equals_with(self, equals: Callable[[_T, _T], bool], other: FSharpArray[_T]) -> bool: ...
    def remove_in_place(self, item: _T) -> bool: ...
    def index_of(
        self, item: _T, start: Int32 | None = None, count: Int32 | None = None, eq: IEqualityComparer[_T] | None = None
    ) -> Int32: ...
    def copy_to(self, source_index: Int32, target: FSharpArray[_T], target_index: Int32, count: Int32) -> None: ...
    ...
    def insert_range_in_place(self, index: Int32, values: Iterable[_T]) -> None: ...
    def get_sub_array(
        self, start_index: Int32, count: Int32, cons: FSharpCons[_T] | None = None
    ) -> FSharpArray[_T]: ...
    ...
    def remove_all_in_place(self, predicate: Callable[[_T], bool]) -> Int32: ...
    def indexed(self) -> FSharpArray[tuple[Int32, _T]]: ...
    def last(self) -> _T: ...
    def try_last(self) -> _T | None: ...
    def skip(self, count: Int32, cons: FSharpCons[_T] | None = None) -> FSharpArray[_T]: ...
    def take(self, count: Int32, cons: FSharpCons[_T] | None = None) -> FSharpArray[_T]: ...
    def truncate(self, count: Int32) -> FSharpArray[_T]: ...
    def partition(
        self, f: Callable[[_T], bool], cons: FSharpCons[_T] | None = None
    ) -> tuple[FSharpArray[_T], FSharpArray[_T]]: ...
    def resize(
        self, new_size: Int32, zero: _T | None = None, cons: FSharpCons[_T] | None = None
    ) -> FSharpArray[_T]: ...
...
def chunk_by_size(chunk_size: Int32, array: FSharpArray[_T]) -> FSharpArray[FSharpArray[_T]]: ...
def compare_with(comparer: Callable[[_T, _T], Int32], array1: FSharpArray[_T], array2: FSharpArray[_T]) -> Int32: ...
def compare_to(comparer: Callable[[_T, _T], Int32], source1: FSharpArray[_T], source2: FSharpArray[_T]) -> Int32: ...
def create(count: Int32, value: _T) -> FSharpArray[_T]: ...
...
def initialize(
    count: Int32, initializer: Callable[[Int32], _T], cons: FSharpCons[_T] | None = None
) -> FSharpArray[_T]: ...
def insert_at(index: Int32, value: _T, array: FSharpArray[_T], cons: FSharpCons[_T] | None = None) -> None: ...
def insert_many_at(
    index: Int32, values: FSharpArray[_T], array: FSharpArray[_T], cons: FSharpCons[_T] | None = None
) -> FSharpArray[_T]: ...
def item(index: Int32, array: FSharpArray[_T]) -> _T: ...
def iterate(action: Callable[[_T], None], array: FSharpArray[_T]) -> None: ...
def iterate_indexed(action: Callable[[Int32, _T], None], array: FSharpArray[_T]) -> None: ...
...
def map_indexed(
    f: Callable[[Int32, _T], _U], array: FSharpArray[_T], cons: FSharpCons[_U] | None = None
) -> FSharpArray[_U]: ...
def map_indexed2(
    f: Callable[[Int32, _T1, _T2], _U],
    array1: FSharpArray[_T1],
...
def map_indexed3(
    f: Callable[[Int32, _T1, _T2, _T3], _U],
    array1: FSharpArray[_T1],
    array2: FSharpArray[_T2],
    array3: FSharpArray[_T3],
    cons: FSharpCons[_U] | None = None,
...
def permute(f: Callable[[Int32], Int32], array: FSharpArray[_T]) -> FSharpArray[_T]: ...
...
def remove_at(index: Int32, array: FSharpArray[_T], cons: FSharpCons[_T] | None = None) -> FSharpArray[_T]: ...
def remove_many_at(index: Int32, count: Int32, array: FSharpArray[_T]) -> FSharpArray[_T]: ...
def remove_in_place(array: FSharpArray[_T], item: _T) -> bool: ...
def index_of(
    array: FSharpArray[_T],
    item: _T,
    start: Int32 | None = None,
...
def set_slice(target: FSharpArray[_T], lower: Int32 | None, upper: Int32 | None, array: FSharpArray[_T]) -> None: ...
def singleton(value: _T, cons: FSharpCons[_T] | None = None) -> FSharpArray[_T]: ...
def skip(count: Int32, array: FSharpArray[_T], cons: FSharpCons[_T] | None = None) -> FSharpArray[_T]: ...
...
def sort_in_place_with(compare_func: Callable[[_T, _T], Int32], array: FSharpArray[_T]) -> None: ...
def sort(array: FSharpArray[_T], comparer: IComparer[_T]) -> FSharpArray[_T]: ...
def split_into(chunks: Int32, array: FSharpArray[_T]) -> FSharpArray[FSharpArray[_T]]: ...
...
def take(count: Int32, array: FSharpArray[_T], cons: FSharpCons[_T] | None = None) -> FSharpArray[_T]: ...
def transpose(
...
def try_find_index(predicate: Callable[[_T], bool], array: FSharpArray[_T]) -> Int32 | None: ...
def try_find_index_back(predicate: Callable[[_T], bool], array: FSharpArray[_T]) -> Int32 | None: ...
def try_head(array: FSharpArray[_T]) -> _T | None: ...
def try_item(index: Int32, array: FSharpArray[_T]) -> _T | None: ...
def update_at(
    index: Int32, value: _T, array: FSharpArray[_T], cons: FSharpCons[_T] | None = None
) -> FSharpArray[_T]: ...
def windowed(window_size: Int32, array: FSharpArray[_T]) -> FSharpArray[FSharpArray[_T]]: ...
def copy_to(
    source: FSharpArray[_T], source_index: Int32, target: FSharpArray[_T], target_index: Int32, count: Int32
) -> None: ...
...
def insert_range_in_place(array: FSharpArray[_T], index: Int32, values: Iterable[_T]) -> None: ...
def get_sub_array(
    array: FSharpArray[_T], start_index: Int32, count: Int32, cons: FSharpCons[_T] | None = None
) -> FSharpArray[_T]: ...
...
def remove_all_in_place(array: FSharpArray[_T], predicate: Callable[[_T], bool]) -> Int32: ...
def resize(
    array: FSharpRef[FSharpArray[_T]], new_size: Int32, zero: _T | None = None, cons: FSharpCons[_T] | None = None
) -> FSharpArray[_T]: ...
...
def indexed(array: FSharpArray[_T]) -> FSharpArray[tuple[Int32, _T]]: ...
...
def truncate(count: Int32, array: FSharpArray[_T]) -> FSharpArray[_T]: ...
def partition(
...
def sort_with(comparer: Callable[[_T, _T], Int32], array: FSharpArray[_T]) -> FSharpArray[_T]: ...
...
class FSharpCons(Generic[_T]):
    ...
    def __call__(self, length: Int32) -> FSharpArray[_T]: ...
    def allocate(self, length: Int32) -> FSharpArray[_T]: ...

def allocate_array_from_cons(cons: FSharpCons[_T] | None, length: Int32) -> FSharpArray[_T]: ...
