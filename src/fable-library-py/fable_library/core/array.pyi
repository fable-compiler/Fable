...
class FSharpArray(MutableSequence[_T]):
    ...
    def sort(self) -> FSharpArray[_T]: ...
    def sort_by(self, projection: Callable[[_T], Any], comparer: IComparer | None = None) -> FSharpArray[_T]: ...
    ...
    def sum_by(self, projection: Callable[[_T], _U]) -> _U: ...
    ...
    def get_sub_array(self, start_index: int, count: int, cons: Any | None = None) -> FSharpArray[_T]: ...
    def contains(self, value: _T) -> bool: ...
    def max(self, comparer: IComparer[_T]) -> _T: ...
    def min(self, comparer: IComparer[_T]) -> _T: ...
    def max_by(self, key: Callable[[_T], Any]) -> _T: ...
    def min_by(self, key: Callable[[_T], Any]) -> _T: ...
    ...
    def partition(self, f: Callable[[_T], bool]) -> tuple[FSharpArray[_T], FSharpArray[_T]]: ...
...
def create(count: int, value: _T) -> FSharpArray[_T]: ...
def empty(cons: Any | None = None) -> FSharpArray[object]: ...
...
def initialize(count: int, initializer: Callable[[int], _T], cons: Any | None = None) -> FSharpArray[_T]: ...
def insert_at(index: int, value: _T, array: FSharpArray[_T], cons: Any | None = None) -> None: ...
def insert_many_at(
...
def map(f: Callable[[_T], _U], array: FSharpArray[_T], cons: Any | None = None) -> FSharpArray[_U]: ...
def map2(
    f: Callable[[_T1, _T2], _U], array1: FSharpArray[_T1], array2: FSharpArray[_T2], cons: Any | None = None
) -> FSharpArray[_U]: ...
def map3(
    f: Callable[[_T1, _T2, _T3], _U],
    array1: FSharpArray[_T1],
...
def map_fold(
    mapping: Callable[[_S, _T], tuple[_R, _S]], state: _S, array: FSharpArray[_T], cons: Any | None = None
) -> tuple[FSharpArray[_R], _S]: ...
def map_fold_back(
    mapping: Callable[[_T, _S], tuple[_R, _S]], array: FSharpArray[_T], state: _S, cons: Any | None = None
) -> tuple[FSharpArray[_R], _S]: ...
def map_indexed(f: Callable[[int, _T], _U], array: FSharpArray[_T], cons: Any | None = None) -> FSharpArray[_U]: ...
def map_indexed2(
    f: Callable[[int, _T1, _T2], _U],
    array1: FSharpArray[_T1],
    array2: FSharpArray[_T2],
...
def scan(
    folder: Callable[[_S, _T], _S], state: _S, array: FSharpArray[_T], cons: Any | None = None
) -> FSharpArray[_S]: ...
def scan_back(
    folder: Callable[[_T, _S], _S], array: FSharpArray[_T], state: _S, cons: Any | None = None
) -> FSharpArray[_S]: ...
...
def skip(count: int, array: FSharpArray[_T], cons: Any | None = None) -> FSharpArray[_T]: ...
...
def sort(array: FSharpArray[_T]) -> FSharpArray[_T]: ...
...
def tail(array: FSharpArray[_T], cons: Any | None = None) -> FSharpArray[_T]: ...
def transpose(array: FSharpArray[FSharpArray[_T]], cons: Any | None = None) -> FSharpArray[FSharpArray[_T]]: ...
...
def update_at(index: int, value: _T, array: FSharpArray[_T], cons: Any | None = None) -> FSharpArray[_T]: ...
...
def get_sub_array(array: FSharpArray[_T], start_index: int, count: int, cons: Any | None = None) -> FSharpArray[_T]: ...
def contains(array: FSharpArray[_T], value: _T) -> bool: ...
def max(array: FSharpArray[_T], comparer: IComparer[_T]) -> _T: ...
def min(array: FSharpArray[_T], comparer: IComparer[_T]) -> _T: ...
def max_by(key: Callable[[_T], Any], array: FSharpArray[_T]) -> _T: ...
def min_by(key: Callable[[_T], Any], array: FSharpArray[_T]) -> _T: ...
def remove_all_in_place(array: FSharpArray[_T], predicate: Callable[[_T], bool]) -> int: ...
def resize(array: FSharpArray[_T], new_size: int, value: _T | None = None) -> FSharpArray[_T]: ...
...
def partition(array: FSharpArray[_T], f: Callable[[_T], bool]) -> tuple[FSharpArray[_T], FSharpArray[_T]]: ...
def concat(arrays: Iterable[FSharpArray[_T]], cons: Any | None = None) -> FSharpArray[_T]: ...
def sort_by(
    projection: Callable[[_T], Any], array: FSharpArray[_T], comparer: IComparer | None = None
) -> FSharpArray[_T]: ...
def sort_with(comparer: Callable[[_T, _T], int], array: FSharpArray[_T]) -> FSharpArray[_T]: ...
def sum_by(projection: Callable[[_T], _U], array: FSharpArray[_T]) -> _U: ...
...
class IGenericAverager(Protocol[_T]):
    ...
    def DivideByInt(self, a: _T, n: int) -> _T: ...
