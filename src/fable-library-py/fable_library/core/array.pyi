...
# Note: Many functions accept FSharpArray[T] | Iterable[T] to support ResizeArray (Python list) compatibility
...
def append[T](array1: FSharpArray[T] | Iterable[T], array2: FSharpArray[T] | Iterable[T], cons: FSharpCons[T] | None = None) -> FSharpArray[T]: ...
def average[T](array: FSharpArray[T] | Iterable[T], averager: IGenericAverager[T]) -> T: ...
def average_by[T, U](projection: Callable[[T], U], array: FSharpArray[T] | Iterable[T], averager: IGenericAverager[U]) -> U: ...
def choose[T, U](
    chooser: Callable[[T], U | None], array: FSharpArray[T] | Iterable[T], cons: FSharpCons[U] | None = None
) -> FSharpArray[U]: ...
def chunk_by_size[T](chunk_size: SupportsInt, array: FSharpArray[T] | Iterable[T]) -> FSharpArray[FSharpArray[T]]: ...
def collect[T, U](
    mapping: Callable[[T], FSharpArray[U]], array: FSharpArray[T] | Iterable[T], cons: FSharpCons[U] | None = None
) -> FSharpArray[U]: ...
def compare_to[T](
    comparer: Callable[[T, T], SupportsInt], source1: FSharpArray[T] | Iterable[T], source2: FSharpArray[T] | Iterable[T]
) -> SupportsInt: ...
def compare_with[T](
    comparer: Callable[[T, T], SupportsInt], array1: FSharpArray[T] | Iterable[T], array2: FSharpArray[T] | Iterable[T]
) -> SupportsInt: ...
def concat[T](arrays: Iterable[FSharpArray[T]], cons: FSharpCons[T] | None = None) -> FSharpArray[T]: ...
def contains[T](value: T, array: FSharpArray[T] | Iterable[T], eq: IEqualityComparer[T] | None = None) -> bool: ...
def copy[T](array: FSharpArray[T] | Iterable[T]) -> FSharpArray[T]: ...
def copy_to[T](
...
def equals_with[T](equals_func: Callable[[T, T], bool], array1: FSharpArray[T] | Iterable[T], array2: FSharpArray[T] | Iterable[T]) -> bool: ...
def exists[T](predicate: Callable[[T], bool], array: FSharpArray[T] | Iterable[T]) -> bool: ...
def exists_offset[T](predicate: Callable[[T], bool], array: FSharpArray[T] | Iterable[T], index: int) -> bool: ...
def fill[T](array: FSharpArray[T], target_index: int, count: int, value: T) -> FSharpArray[T]: ...
def filter[T](predicate: Callable[[T], bool], array: FSharpArray[T] | Iterable[T]) -> FSharpArray[T]: ...
def find[T](predicate: Callable[[T], bool], array: FSharpArray[T] | Iterable[T]) -> T: ...
def find_back[T](predicate: Callable[[T], bool], array: FSharpArray[T] | Iterable[T]) -> T: ...
def find_index[T](predicate: Callable[[T], bool], array: FSharpArray[T] | Iterable[T]) -> int: ...
def find_index_back[T](predicate: Callable[[T], bool], array: FSharpArray[T] | Iterable[T]) -> int: ...
def find_last_index[T](predicate: Callable[[T], bool], array: FSharpArray[T] | Iterable[T]) -> int: ...
def fold[T, S](folder: Callable[[S, T], S], state: S, array: FSharpArray[T] | Iterable[T]) -> S: ...
def fold_back[T, S](folder: Callable[[T, S], S], array: FSharpArray[T] | Iterable[T], state: S) -> S: ...
def fold_back2[T1, T2, S](
    folder: Callable[[T1, T2, S], S], array1: FSharpArray[T1] | Iterable[T1], array2: FSharpArray[T2] | Iterable[T2], state: S
) -> S: ...
def fold_back_indexed[T, S](folder: Callable[[int, T, S], S], array: FSharpArray[T] | Iterable[T], state: S) -> S: ...
def fold_back_indexed2[T1, T2, S](folder: Callable[[int, T1, T2, S], S], array1: FSharpArray[T1] | Iterable[T1], array2: FSharpArray[T2] | Iterable[T2], state: S) -> S: ...
def fold_indexed[T, S](folder: Callable[[int, Any, Any], Any], state: Any, array: FSharpArray[T] | Iterable[T]) -> Any: ...
def for_all[T](predicate: Callable[[T], bool], array: FSharpArray[T] | Iterable[T]) -> bool: ...
def get_sub_array[T](
    array: FSharpArray[T] | Iterable[T], start_index: SupportsInt, count: SupportsInt, cons: FSharpCons[T] | None = None
) -> FSharpArray[T]: ...
def head[T](array: FSharpArray[T] | Iterable[T]) -> T: ...
def index_of[T](
    array: FSharpArray[T] | Iterable[T],
    item: T,
    start: SupportsInt | None = None,
    count: SupportsInt | None = None,
    eq: IEqualityComparer[T] | None = None,
) -> SupportsInt: ...
def indexed[T](array: FSharpArray[T] | Iterable[T]) -> FSharpArray[tuple[SupportsInt, T]]: ...
def initialize[T](
    count: SupportsInt, initializer: Callable[[SupportsInt], T], cons: FSharpCons[T] | None = None
) -> FSharpArray[T]: ...
def insert_at[T](index: SupportsInt, value: T, array: FSharpArray[T] | Iterable[T], cons: FSharpCons[T] | None = None) -> FSharpArray[T]: ...
...
def item[T](index: SupportsInt, array: FSharpArray[T] | Iterable[T]) -> T: ...
def iterate[T](action: Callable[[T], None], array: FSharpArray[T] | Iterable[T]) -> None: ...
def iterate_indexed[T](action: Callable[[SupportsInt, T], None], array: FSharpArray[T] | Iterable[T]) -> None: ...
def last[T](array: FSharpArray[T] | Iterable[T]) -> T: ...
def map[T, U](f: Callable[[T], U], array: FSharpArray[T] | Iterable[T], cons: FSharpCons[U] | None = None) -> FSharpArray[U]: ...
def map2[T1, T2, U](
    f: Callable[[T1, T2], U], array1: FSharpArray[T1] | Iterable[T1], array2: FSharpArray[T2] | Iterable[T2], cons: FSharpCons[U] | None = None
) -> FSharpArray[U]: ...
def map3[T1, T2, T3, U](
    f: Callable[[T1, T2, T3], U],
    array1: FSharpArray[T1] | Iterable[T1],
    array2: FSharpArray[T2] | Iterable[T2],
    array3: FSharpArray[T3] | Iterable[T3],
    cons: FSharpCons[U] | None = None,
) -> FSharpArray[U]: ...
def map_fold[T, S, R](
    mapping: Callable[[S, T], tuple[R, S]], state: S, array: FSharpArray[T] | Iterable[T], cons: FSharpCons[R] | None = None
) -> tuple[FSharpArray[R], S]: ...
def map_fold_back[T, S, R](
    mapping: Callable[[T, S], tuple[R, S]], array: FSharpArray[T] | Iterable[T], state: S, cons: FSharpCons[R] | None = None
) -> tuple[FSharpArray[R], S]: ...
def map_indexed[T, U](
    f: Callable[[SupportsInt, T], U], array: FSharpArray[T] | Iterable[T], cons: FSharpCons[U] | None = None
) -> FSharpArray[U]: ...
def map_indexed2[T1, T2, U](
    f: Callable[[SupportsInt, T1, T2], U],
    array1: FSharpArray[T1] | Iterable[T1],
...
def max[T](array: FSharpArray[T] | Iterable[T], comparer: IComparer[T]) -> T: ...
def max_by[T, U](projection: Callable[[T], U], array: FSharpArray[T] | Iterable[T], comparer: IComparer[U]) -> T: ...
def min[T](array: FSharpArray[T] | Iterable[T], comparer: IComparer[T]) -> T: ...
def min_by[T, U](projection: Callable[[T], U], array: FSharpArray[T] | Iterable[T], comparer: IComparer[U]) -> T: ...
def of_seq[T](seq: Iterable[T], cons: FSharpCons[T] | None = None) -> FSharpArray[T]: ...
def pairwise[T](array: FSharpArray[T] | Iterable[T]) -> FSharpArray[tuple[T, T]]: ...
def partition[T](
...
def reverse[T](array: FSharpArray[T] | Iterable[T]) -> FSharpArray[T]: ...
def scan[T, S](
    folder: Callable[[S, T], S], state: S, array: FSharpArray[T] | Iterable[T], cons: FSharpCons[S] | None = None
) -> FSharpArray[S]: ...
def scan_back[T, S](
    folder: Callable[[T, S], S], array: FSharpArray[T] | Iterable[T], state: S, cons: FSharpCons[S] | None = None
) -> FSharpArray[S]: ...
def set_slice[T](
...
def skip[T](count: SupportsInt, array: FSharpArray[T] | Iterable[T], cons: FSharpCons[T] | None = None) -> FSharpArray[T]: ...
def skip_while[T](
    predicate: Callable[[T], bool], array: FSharpArray[T] | Iterable[T], cons: FSharpCons[T] | None = None
) -> FSharpArray[T]: ...
def sort[T](array: FSharpArray[T] | Iterable[T], comparer: IComparer[T]) -> FSharpArray[T]: ...
def sort_by[T](
    projection: Callable[[T], Any], array: FSharpArray[T] | Iterable[T], comparer: IComparer[T] | None = None
) -> FSharpArray[T]: ...
...
def sort_with[T](comparer: Callable[[T, T], SupportsInt], array: FSharpArray[T] | Iterable[T]) -> FSharpArray[T]: ...
def split_into[T](chunks: SupportsInt, array: FSharpArray[T] | Iterable[T]) -> FSharpArray[FSharpArray[T]]: ...
def sum[T](array: FSharpArray[T] | Iterable[T], adder: IGenericAdder[T]) -> T: ...
def sum_by[T, U](projection: Callable[[T], U], array: FSharpArray[T] | Iterable[T], adder: IGenericAdder[U]) -> U: ...
def tail[T](array: FSharpArray[T] | Iterable[T], cons: FSharpCons[T] | None = None) -> FSharpArray[T]: ...
def take[T](count: SupportsInt, array: FSharpArray[T] | Iterable[T], cons: FSharpCons[T] | None = None) -> FSharpArray[T]: ...
def take_while[T](
    predicate: Callable[[T], bool], array: FSharpArray[T] | Iterable[T], cons: FSharpCons[T] | None = None
) -> FSharpArray[T]: ...
def transpose[T](
...
def truncate[T](count: SupportsInt, array: FSharpArray[T] | Iterable[T]) -> FSharpArray[T]: ...
def try_find[T](predicate: Callable[[T], bool], array: FSharpArray[T] | Iterable[T]) -> T | None: ...
def try_find_back[T](predicate: Callable[[T], bool], array: FSharpArray[T] | Iterable[T]) -> T | None: ...
def try_find_index[T](predicate: Callable[[T], bool], array: FSharpArray[T] | Iterable[T]) -> SupportsInt | None: ...
def try_find_index_back[T](predicate: Callable[[T], bool], array: FSharpArray[T] | Iterable[T]) -> SupportsInt | None: ...
def try_head[T](array: FSharpArray[T] | Iterable[T]) -> T | None: ...
def try_item[T](index: SupportsInt, array: FSharpArray[T] | Iterable[T]) -> T | None: ...
def try_last[T](array: FSharpArray[T] | Iterable[T]) -> T | None: ...
def try_pick[T, U](chooser: Callable[[T], U | None], array: FSharpArray[T] | Iterable[T]) -> U | None: ...
def unzip[T, U](array: FSharpArray[tuple[T, U]] | Iterable[tuple[T, U]]) -> tuple[FSharpArray[T], FSharpArray[U]]: ...
def update_at[T](
    index: SupportsInt, value: T, array: FSharpArray[T] | Iterable[T], cons: FSharpCons[T] | None = None
) -> FSharpArray[T]: ...
def windowed[T](window_size: SupportsInt, array: FSharpArray[T] | Iterable[T]) -> FSharpArray[FSharpArray[T]]: ...
def zip[T, U](array1: FSharpArray[T] | Iterable[T], array2: FSharpArray[U] | Iterable[U]) -> FSharpArray[tuple[T, U]]: ...
