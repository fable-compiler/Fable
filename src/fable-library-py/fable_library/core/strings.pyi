...
def map_indexed(mapping: Callable[[int, str], str], x: str) -> str: ...
...
def starts_with(string: str, pattern: str, ic: int | bool | None = None) -> bool: ...
def ends_with(string: str, pattern: str, ic: int | bool | None = None) -> bool: ...
