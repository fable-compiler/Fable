...
@overload
def map(mapping: Callable[[_T], Option[_U]], opt: _T | None) -> Option[_U]: ...
@overload
...
@overload
def map3(mapping: Callable[[_T, _U, _V], _W], opt1: _T | None, opt2: _U | None, opt3: _V | None) -> _W | None: ...
@overload
...
@overload
def or_else(opt: SomeWrapper[None], if_none: Option[_T]) -> Option[_T]: ...
@overload
def or_else(opt: Option[_T], if_none: Option[_U]) -> Option[_T | _U]: ...
@overload
def or_else_with(opt: SomeWrapper[None], if_none_thunk: Callable[[], Option[_T]]) -> Option[_T]: ...
@overload
def or_else_with(opt: Option[_T], if_none_thunk: Callable[[], Option[_U]]) -> Option[_T | _U]: ...
