...
let rangeBigInt start step stop = integralRangeStep start step stop 0I (+)
let rangeDecimal start step stop = integralRangeStep start step stop 0m (+)
let rangeDouble start step stop = integralRangeStep start step stop 0.0 (+)
let rangeInt64 start step stop = integralRangeStep start step stop 0L (+)
let rangeUInt64 start step stop = integralRangeStep start step stop 0UL (+)
