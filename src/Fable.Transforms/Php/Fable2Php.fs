    ...
    | Fable.Set(expr,kind,value,_) ->
        ...
        let leftAssign = 
            ...
            | Fable.SetKind.ValueSet ->
                ...
                | _ -> ()
                left
            | Fable.SetKind.FieldSet(field,_) ->
                PhpField(left, Prop.StrField field.Name, None)
            | Fable.SetKind.ByKeySet(Fable.ExprKey(keyExpr)) ->
                PhpArrayAccess(left, convertExpr com keyExpr)
            | Fable.SetKind.ByKeySet(Fable.FieldKey(field)) ->
                PhpField(left, Prop.StrField field.Name, None)
