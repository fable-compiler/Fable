...
type CompilerImpl(currentFile, project: Project, options, fableLibraryDir: string, ?outDir: string, ?outType: OutputType,
    ...
    let outputType = defaultArg outType OutputType.Library
