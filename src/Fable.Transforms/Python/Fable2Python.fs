...
module Util =
    ...
    let rec isPyStatement ctx preferStatement (expr: Fable.Expr) =
        ...
        | Fable.Extended(kind, _) ->
            match kind with
            | Fable.Throw _ | Fable.Return _ | Fable.Break _ | Fable.Debugger | Fable.Delimiter -> true
            | Fable.Curry _ -> false
...
//            com.GetIdentifierAsExpr(ctx, n)
    ...
    let makeArrowFunctionExpression com ctx (name: string option) (args: Arguments) (body: Statement list) returnType : Expression * Statement list =
        let args =
            match args.Args with
            | [] ->
...
//                fn, stmts
    ...
    let rec transformAsExpr (com: IPythonCompiler) ctx (expr: Fable.Expr): Expression * Statement list =
        ...
        | Fable.Extended(instruction, _) ->
            ...
            | Fable.Throw _ | Fable.Return _ | Fable.Break _ | Fable.Debugger | Fable.Delimiter -> iife com ctx expr
    ...
    let rec transformAsStatements (com: IPythonCompiler) ctx returnStrategy
        ...
        | Fable.Extended(kind, _r) ->
            ...
            | Fable.Delimiter -> [ Statement.Delimiter ]
