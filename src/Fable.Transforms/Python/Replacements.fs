...
let toLong com (ctx: Context) r (unsigned: bool) targetType (args: Expr list) : Expr =
    ...
    | Number(kind, _) ->
        ...
        | Float32
        | Float64 -> Helper.LibCall(com, "long", "fromNumber", targetType, args @ [ makeBoolConst unsigned ])
...
let optionModule isStruct (com: ICompiler) (ctx: Context) r (t: Type) (i: CallInfo) (_: Expr option) (args: Expr list) =
    ...
    | ("ToObj" | "ToNullable"), _ -> Helper.LibCall(com, "option", "toNullable", t, args, ?loc = r) |> Some
