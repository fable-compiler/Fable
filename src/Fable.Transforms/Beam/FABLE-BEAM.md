...
5. Runs an Erlang test runner (`erl_test_runner.erl`) with `-pa fable_modules/fable-library-beam` that discovers and executes all `test_`-prefixed functions (2025 Erlang tests pass)
...
- [x] Test suite (`tests/Beam/` — 2025 Erlang tests passing, `./build.sh test beam`)
