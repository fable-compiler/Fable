...
module Atts =
    ...
    let [<Literal>] taggedUnion = "Fable.Core.TaggedUnionAttribute" // typeof<Fable.Core.TaggedUnionAttribute>.FullName
    let [<Literal>] case = "Fable.Core.CaseAttribute" // typeof<Fable.Core.CaseAttribute>.FullName
