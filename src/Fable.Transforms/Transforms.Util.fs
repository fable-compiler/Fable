...
module Atts =
    ...
    let [<Literal>] rustAsync = "Fable.Core.Rust.AsyncAttribute"// typeof<Fable.Core.Rust.AsyncAttribute>.FullName
    let [<Literal>] rustConst = "Fable.Core.Rust.ConstAttribute"// typeof<Fable.Core.Rust.ConstAttribute>.FullName
    let [<Literal>] rustExtern = "Fable.Core.Rust.ExternAttribute"// typeof<Fable.Core.Rust.ExternAttribute>.FullName
    let [<Literal>] rustUnsafe = "Fable.Core.Rust.UnsafeAttribute"// typeof<Fable.Core.Rust.UnsafeAttribute>.FullName
