...
type IFableManager =
    ...
    abstract CompileToBabelAst: fableReplacements: string * parseResults: IParseResults * fileName: string * optimized: bool * ?replacementsLib: (string->(string*string) option) -> IBabelResult
