...
module JS =
    ...
    type [<AllowNullLiteral>] [<Global>] Reflect =
        ...
        static member get(target: obj, propertyKey: PropertyKey, ?receiver: obj): obj = jsNative
        static member getOwnPropertyDescriptor(target: obj, propertyKey: PropertyKey): PropertyDescriptor = jsNative
        ...
        static member ownKeys(target: obj): ResizeArray<PropertyKey> = jsNative
