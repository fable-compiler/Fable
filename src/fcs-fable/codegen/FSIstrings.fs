// This is a generated file; the original input is '/Users/alfonsogarciacaronunez/dev/FSharp.Compiler.Service_fable/src/fsharp/fsi/FSIstrings.txt'
namespace FSIstrings
type internal SR private() =
    /// Stopped due to error\n
    /// (Originally from /Users/alfonsogarciacaronunez/dev/FSharp.Compiler.Service_fable/src/fsharp/fsi/FSIstrings.txt:2)
    static member stoppedDueToError() = (sprintf "Stopped due to error\n" )
    /// Usage: %s <options> [script.fsx [<arguments>]]
    /// (Originally from /Users/alfonsogarciacaronunez/dev/FSharp.Compiler.Service_fable/src/fsharp/fsi/FSIstrings.txt:3)
    static member fsiUsage(a0 : System.String) = (sprintf "Usage: %s <options> [script.fsx [<arguments>]]" a0)
    /// - INPUT FILES -
    /// (Originally from /Users/alfonsogarciacaronunez/dev/FSharp.Compiler.Service_fable/src/fsharp/fsi/FSIstrings.txt:4)
    static member fsiInputFiles() = (sprintf "- INPUT FILES -" )
    /// - CODE GENERATION -
    /// (Originally from /Users/alfonsogarciacaronunez/dev/FSharp.Compiler.Service_fable/src/fsharp/fsi/FSIstrings.txt:5)
    static member fsiCodeGeneration() = (sprintf "- CODE GENERATION -" )
    /// - ERRORS AND WARNINGS -
    /// (Originally from /Users/alfonsogarciacaronunez/dev/FSharp.Compiler.Service_fable/src/fsharp/fsi/FSIstrings.txt:6)
    static member fsiErrorsAndWarnings() = (sprintf "- ERRORS AND WARNINGS -" )
    /// - LANGUAGE -
    /// (Originally from /Users/alfonsogarciacaronunez/dev/FSharp.Compiler.Service_fable/src/fsharp/fsi/FSIstrings.txt:7)
    static member fsiLanguage() = (sprintf "- LANGUAGE -" )
    /// - MISCELLANEOUS -
    /// (Originally from /Users/alfonsogarciacaronunez/dev/FSharp.Compiler.Service_fable/src/fsharp/fsi/FSIstrings.txt:8)
    static member fsiMiscellaneous() = (sprintf "- MISCELLANEOUS -" )
    /// - ADVANCED -
    /// (Originally from /Users/alfonsogarciacaronunez/dev/FSharp.Compiler.Service_fable/src/fsharp/fsi/FSIstrings.txt:9)
    static member fsiAdvanced() = (sprintf "- ADVANCED -" )
    /// Exception raised when starting remoting server.\n%s
    /// (Originally from /Users/alfonsogarciacaronunez/dev/FSharp.Compiler.Service_fable/src/fsharp/fsi/FSIstrings.txt:10)
    ...
    /// (Originally from /Users/alfonsogarciacaronunez/dev/FSharp.Compiler.Service_fable/src/fsharp/fsi/FSIstrings.txt:11)
    static member fsiUse() = (sprintf "Use the given file on startup as initial input" )
    /// #load the given file on startup
    /// (Originally from /Users/alfonsogarciacaronunez/dev/FSharp.Compiler.Service_fable/src/fsharp/fsi/FSIstrings.txt:12)
    ...
    /// (Originally from /Users/alfonsogarciacaronunez/dev/FSharp.Compiler.Service_fable/src/fsharp/fsi/FSIstrings.txt:13)
    ...
    /// (Originally from /Users/alfonsogarciacaronunez/dev/FSharp.Compiler.Service_fable/src/fsharp/fsi/FSIstrings.txt:14)
    ...
    /// (Originally from /Users/alfonsogarciacaronunez/dev/FSharp.Compiler.Service_fable/src/fsharp/fsi/FSIstrings.txt:15)
    ...
    /// (Originally from /Users/alfonsogarciacaronunez/dev/FSharp.Compiler.Service_fable/src/fsharp/fsi/FSIstrings.txt:16)
    ...
    /// (Originally from /Users/alfonsogarciacaronunez/dev/FSharp.Compiler.Service_fable/src/fsharp/fsi/FSIstrings.txt:17)
    static member fsiQuiet() = (sprintf "Suppress fsi writing to stdout" )
    /// Support TAB completion in console (on by default)
    /// (Originally from /Users/alfonsogarciacaronunez/dev/FSharp.Compiler.Service_fable/src/fsharp/fsi/FSIstrings.txt:18)
    static member fsiReadline() = (sprintf "Support TAB completion in console (on by default)" )
    /// Emit debug information in quotations
    /// (Originally from /Users/alfonsogarciacaronunez/dev/FSharp.Compiler.Service_fable/src/fsharp/fsi/FSIstrings.txt:19)
    static member fsiEmitDebugInfoInQuotations() = (sprintf "Emit debug information in quotations" )
    /// For help type #help;;
    /// (Originally from /Users/alfonsogarciacaronunez/dev/FSharp.Compiler.Service_fable/src/fsharp/fsi/FSIstrings.txt:20)
    ...
    /// (Originally from /Users/alfonsogarciacaronunez/dev/FSharp.Compiler.Service_fable/src/fsharp/fsi/FSIstrings.txt:21)
    ...
    /// (Originally from /Users/alfonsogarciacaronunez/dev/FSharp.Compiler.Service_fable/src/fsharp/fsi/FSIstrings.txt:22)
    static member fsiInvalidAssembly(a0 : System.String) = (2301, sprintf "'%s' is not a valid assembly name" a0)
    /// Directory '%s' doesn't exist
    /// (Originally from /Users/alfonsogarciacaronunez/dev/FSharp.Compiler.Service_fable/src/fsharp/fsi/FSIstrings.txt:23)
    static member fsiDirectoryDoesNotExist(a0 : System.String) = (2302, sprintf "Directory '%s' doesn't exist" a0)
    /// Invalid directive '#%s %s'
    /// (Originally from /Users/alfonsogarciacaronunez/dev/FSharp.Compiler.Service_fable/src/fsharp/fsi/FSIstrings.txt:24)
    static member fsiInvalidDirective(a0 : System.String, a1 : System.String) = (sprintf "Invalid directive '#%s %s'" a0 a1)
    /// Warning: line too long, ignoring some characters\n
    /// (Originally from /Users/alfonsogarciacaronunez/dev/FSharp.Compiler.Service_fable/src/fsharp/fsi/FSIstrings.txt:25)
    static member fsiLineTooLong() = (sprintf "Warning: line too long, ignoring some characters\n" )
    /// Real: %s, CPU: %s, GC %s
    /// (Originally from /Users/alfonsogarciacaronunez/dev/FSharp.Compiler.Service_fable/src/fsharp/fsi/FSIstrings.txt:26)
    ...
    /// gen
    /// (Originally from /Users/alfonsogarciacaronunez/dev/FSharp.Compiler.Service_fable/src/fsharp/fsi/FSIstrings.txt:27)
    static member fsiTimeInfoGCGenerationLabelSomeShorthandForTheWordGeneration() = (sprintf "gen" )
    /// \n\nException raised during pretty printing.\nPlease report this so it can be fixed.\nTrace: %s\n
    /// (Originally from /Users/alfonsogarciacaronunez/dev/FSharp.Compiler.Service_fable/src/fsharp/fsi/FSIstrings.txt:28)
    static member fsiExceptionDuringPrettyPrinting(a0 : System.String) = (sprintf "\n\nException raised during pretty printing.\nPlease report this so it can be fixed.\nTrace: %s\n" a0)
    ///   F# Interactive directives:
    /// (Originally from /Users/alfonsogarciacaronunez/dev/FSharp.Compiler.Service_fable/src/fsharp/fsi/FSIstrings.txt:29)
    static member fsiIntroTextHeader1directives() = (sprintf "  F# Interactive directives:" )
    /// Reference (dynamically load) the given DLL
    /// (Originally from /Users/alfonsogarciacaronunez/dev/FSharp.Compiler.Service_fable/src/fsharp/fsi/FSIstrings.txt:30)
    ...
    /// (Originally from /Users/alfonsogarciacaronunez/dev/FSharp.Compiler.Service_fable/src/fsharp/fsi/FSIstrings.txt:31)
    ...
    /// (Originally from /Users/alfonsogarciacaronunez/dev/FSharp.Compiler.Service_fable/src/fsharp/fsi/FSIstrings.txt:32)
    static member fsiIntroTextHashloadInfo() = (sprintf "Load the given file(s) as if compiled and referenced" )
    /// Toggle timing on/off
    /// (Originally from /Users/alfonsogarciacaronunez/dev/FSharp.Compiler.Service_fable/src/fsharp/fsi/FSIstrings.txt:33)
    static member fsiIntroTextHashtimeInfo() = (sprintf "Toggle timing on/off" )
    /// Display help
    /// (Originally from /Users/alfonsogarciacaronunez/dev/FSharp.Compiler.Service_fable/src/fsharp/fsi/FSIstrings.txt:34)
    static member fsiIntroTextHashhelpInfo() = (sprintf "Display help" )
    /// Exit
    /// (Originally from /Users/alfonsogarciacaronunez/dev/FSharp.Compiler.Service_fable/src/fsharp/fsi/FSIstrings.txt:35)
    static member fsiIntroTextHashquitInfo() = (sprintf "Exit" )
    ///   F# Interactive command line options:
    /// (Originally from /Users/alfonsogarciacaronunez/dev/FSharp.Compiler.Service_fable/src/fsharp/fsi/FSIstrings.txt:36)
    static member fsiIntroTextHeader2commandLine() = (sprintf "  F# Interactive command line options:" )
    ///       See '%s' for options
    /// (Originally from /Users/alfonsogarciacaronunez/dev/FSharp.Compiler.Service_fable/src/fsharp/fsi/FSIstrings.txt:37)
    static member fsiIntroTextHeader3(a0 : System.String) = (sprintf "      See '%s' for options" a0)
    /// Loading
    /// (Originally from /Users/alfonsogarciacaronunez/dev/FSharp.Compiler.Service_fable/src/fsharp/fsi/FSIstrings.txt:38)
    static member fsiLoadingFilesPrefixText() = (sprintf "Loading" )
    /// \n- Interrupt\n
    /// (Originally from /Users/alfonsogarciacaronunez/dev/FSharp.Compiler.Service_fable/src/fsharp/fsi/FSIstrings.txt:39)
    static member fsiInterrupt() = (sprintf "\n- Interrupt\n" )
    /// \n- Exit...\n
    /// (Originally from /Users/alfonsogarciacaronunez/dev/FSharp.Compiler.Service_fable/src/fsharp/fsi/FSIstrings.txt:40)
    static member fsiExit() = (sprintf "\n- Exit...\n" )
    /// - Aborting main thread...
    /// (Originally from /Users/alfonsogarciacaronunez/dev/FSharp.Compiler.Service_fable/src/fsharp/fsi/FSIstrings.txt:41)
    ...
    /// (Originally from /Users/alfonsogarciacaronunez/dev/FSharp.Compiler.Service_fable/src/fsharp/fsi/FSIstrings.txt:42)
    ...
    /// --> Referenced '%s'
    /// (Originally from /Users/alfonsogarciacaronunez/dev/FSharp.Compiler.Service_fable/src/fsharp/fsi/FSIstrings.txt:43)
    ...
    /// (Originally from /Users/alfonsogarciacaronunez/dev/FSharp.Compiler.Service_fable/src/fsharp/fsi/FSIstrings.txt:44)
    ...
    /// (Originally from /Users/alfonsogarciacaronunez/dev/FSharp.Compiler.Service_fable/src/fsharp/fsi/FSIstrings.txt:45)
    ...
    /// (Originally from /Users/alfonsogarciacaronunez/dev/FSharp.Compiler.Service_fable/src/fsharp/fsi/FSIstrings.txt:46)
    static member fsiDidAHashI(a0 : System.String) = (sprintf "--> Added '%s' to library include path" a0)
    /// --> Timing now on
    /// (Originally from /Users/alfonsogarciacaronunez/dev/FSharp.Compiler.Service_fable/src/fsharp/fsi/FSIstrings.txt:47)
    static member fsiTurnedTimingOn() = (sprintf "--> Timing now on" )
    /// --> Timing now off
    /// (Originally from /Users/alfonsogarciacaronunez/dev/FSharp.Compiler.Service_fable/src/fsharp/fsi/FSIstrings.txt:48)
    ...
    /// (Originally from /Users/alfonsogarciacaronunez/dev/FSharp.Compiler.Service_fable/src/fsharp/fsi/FSIstrings.txt:49)
    ...
    /// (Originally from /Users/alfonsogarciacaronunez/dev/FSharp.Compiler.Service_fable/src/fsharp/fsi/FSIstrings.txt:50)
    static member fsiFailedToResolveAssembly(a0 : System.String) = (sprintf "Failed to resolve assembly '%s'" a0)
    /// Binding session to '%s'...
    /// (Originally from /Users/alfonsogarciacaronunez/dev/FSharp.Compiler.Service_fable/src/fsharp/fsi/FSIstrings.txt:51)
    static member fsiBindingSessionTo(a0 : System.String) = (sprintf "Binding session to '%s'..." a0)
    /// Microsoft (R) F# Interactive version %s
    /// (Originally from /Users/alfonsogarciacaronunez/dev/FSharp.Compiler.Service_fable/src/fsharp/fsi/FSIstrings.txt:52)
    static member fsiProductName(a0 : System.String) = (sprintf "Microsoft (R) F# Interactive version %s" a0)
    /// F# Interactive for F# %s
    /// (Originally from /Users/alfonsogarciacaronunez/dev/FSharp.Compiler.Service_fable/src/fsharp/fsi/FSIstrings.txt:53)
    ...
    /// (Originally from /Users/alfonsogarciacaronunez/dev/FSharp.Compiler.Service_fable/src/fsharp/fsi/FSIstrings.txt:54)
