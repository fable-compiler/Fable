...
type internal SR private() =
    ...
    /// (Originally from src/fsharp/fsi/FSIstrings.txt:13)
    ...
    /// (Originally from src/fsharp/fsi/FSIstrings.txt:14)
    ...
    /// (Originally from src/fsharp/fsi/FSIstrings.txt:15)
    ...
    /// (Originally from src/fsharp/fsi/FSIstrings.txt:16)
    ...
    /// (Originally from src/fsharp/fsi/FSIstrings.txt:21)
    ...
    /// (Originally from src/fsharp/fsi/FSIstrings.txt:25)
    static member fsiLineTooLong() = (sprintf "Warning: line too long, ignoring some characters\n" )
    /// Real: %s, CPU: %s, GC %s
    /// (Originally from src/fsharp/fsi/FSIstrings.txt:26)
    ...
    /// (Originally from src/fsharp/fsi/FSIstrings.txt:31)
    ...
    /// (Originally from src/fsharp/fsi/FSIstrings.txt:42)
    ...
    /// --> Referenced '%s'
    /// (Originally from src/fsharp/fsi/FSIstrings.txt:43)
    ...
    /// (Originally from src/fsharp/fsi/FSIstrings.txt:44)
    ...
    /// (Originally from src/fsharp/fsi/FSIstrings.txt:45)
    ...
    /// (Originally from src/fsharp/fsi/FSIstrings.txt:46)
    static member fsiDidAHashI(a0 : System.String) = (sprintf "--> Added '%s' to library include path" a0)
    /// --> Timing now on
    /// (Originally from src/fsharp/fsi/FSIstrings.txt:47)
    static member fsiTurnedTimingOn() = (sprintf "--> Timing now on" )
    /// --> Timing now off
    /// (Originally from src/fsharp/fsi/FSIstrings.txt:48)
    ...
    /// (Originally from src/fsharp/fsi/FSIstrings.txt:49)
    ...
    /// (Originally from src/fsharp/fsi/FSIstrings.txt:54)
    ...
    /// (Originally from src/fsharp/fsi/FSIstrings.txt:55)
    ...
    /// (Originally from src/fsharp/fsi/FSIstrings.txt:56)
