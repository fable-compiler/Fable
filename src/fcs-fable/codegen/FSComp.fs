...
type internal SR private() =
    ...
    static member optsPdbMatchesOutputFileName() = (1503, sprintf "The pdb output file name cannot match the build output filename use --pdb:filename.pdb" )
    ...
    static member optsInvalidRefAssembly() = (2030, sprintf "Invalid use of emitting a reference assembly, do not use '--staticlink', or '--refonly' and '--refout' together." )
    ...
    static member parsExpectingExpressionInTuple() = (3524, sprintf "Expecting expression" )
    ...
    static member parsExpectingPatternInTuple() = (3546, sprintf "Expecting pattern" )
