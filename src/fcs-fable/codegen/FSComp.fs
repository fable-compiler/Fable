...
type internal SR private() =
    ...
    static member tcImplicitConversionUsedForMethodArg(a0 : System.String, a1 : System.String, a2 : System.String) = (3390, sprintf "This expression uses the implicit conversion '%s' to convert type '%s' to type '%s'." a0 a1 a2)
