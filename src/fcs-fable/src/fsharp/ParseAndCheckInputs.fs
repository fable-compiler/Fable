...
let ShowAllTokensAndExit (shortFilename, tokenizer: Tokenizer, lexbuf: UnicodeLexing.Lexbuf) =
    while true do
...
let TestInteractionParserAndExit (tokenizer: Tokenizer, lexbuf: UnicodeLexing.Lexbuf) =
    while true do
