...
type internal LexBuffer<'Char> =
    ...
    static member FromChars: reportLibraryOnlyFeatures: bool * langVersion: LanguageVersion * LexBufferChar[] -> LexBuffer<LexBufferChar>

    /// Create a lex buffer suitable for Unicode lexing that reads characters from the given string.
    static member FromString: reportLibraryOnlyFeatures: bool * langVersion: LanguageVersion * string -> LexBuffer<LexBufferChar>

    /// Create a lex buffer that reads character or byte inputs by using the given function.
    static member FromFunction: reportLibraryOnlyFeatures: bool * langVersion: LanguageVersion * ('Char[] * int * int -> int) -> LexBuffer<'Char>

    /// Create a lex buffer backed by source text.
    static member FromSourceText: reportLibraryOnlyFeatures: bool * langVersion: LanguageVersion * ISourceText -> LexBuffer<LexBufferChar>
