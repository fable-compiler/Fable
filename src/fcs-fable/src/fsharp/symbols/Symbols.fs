...
type FSharpActivePatternCase(cenv, apinfo: PrettyNaming.ActivePatternInfo, ty, n, valOpt: ValRef option, item2) = 
...
type FSharpMemberOrFunctionOrValue(cenv, d:FSharpMemberOrValData, item2) = 
