...
module JS =
    ...
    let [<Global>] eval: string -> string = failwith "JS only" 
    let [<Global>] isFinite: float -> bool = failwith "JS only" 
    let [<Global>] isNaN: float -> bool = failwith "JS only"
    let [<Global>] parseFloat: string -> float = failwith "JS only" 
    let [<Global>] parseInt: string -> int -> int = failwith "JS only" 
    let [<Global>] decodeURI: string -> string = failwith "JS only" 
    let [<Global>] decodeURIComponent: string -> string = failwith "JS only" 
