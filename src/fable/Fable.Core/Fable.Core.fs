...
/// More info: http://fsprojects.github.io/Fable/docs/interacting.html#Erase-attribute
type EraseAttribute() =
    inherit Attribute()

/// The module, type, function... is globally accessible in JS.
/// More info: http://fsprojects.github.io/Fable/docs/interacting.html#Import-attribute
...
/// More info: http://fsprojects.github.io/Fable/docs/interacting.html#KeyValueList-attribute
type KeyValueListAttribute() =
    inherit Attribute()

/// Compile union types as string literals.
/// More info: http://fsprojects.github.io/Fable/docs/interacting.html#StringEnum-attribute
