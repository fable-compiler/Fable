...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.selectGameOnChange = exports.newGameOnClick = exports.config = exports.selectColors = exports.selectHeight = exports.selectWidth = exports.selectGame = exports.buttonNewGame = exports.defaultConfig = exports.rndColorGtor = exports.strToInt = exports.updateUi = exports.renderBoardToHtmlString = exports.api = exports.SameGameDomain = exports.SameGameTypes = undefined;
	...
	var _games = __webpack_require__(2);
	...
	var updateUi = exports.updateUi = function (game) {
	    ...
	    game != null ? game.Case === "Finished" ? (gs = game.Fields[0], board = renderBoardToHtmlString(gs.Board), boardElement.innerHTML = board, scoreElement.innerText = function () {
	        return function () {
	            var clo1;
	...
	var strToInt = exports.strToInt = function (str) {
	...
	var selectGame = exports.selectGame = document.getElementById("sg-select-game");
	var selectWidth = exports.selectWidth = document.getElementById("sg-select-w");
	var selectHeight = exports.selectHeight = document.getElementById("sg-select-h");
	var selectColors = exports.selectColors = document.getElementById("sg-select-col");
	
	var config = exports.config = function () {
	    return new SameGameTypes.GameConfig(strToInt(selectWidth.value), strToInt(selectHeight.value), rndColorGtor(strToInt(selectColors.value)));
	};
	...
	var selectGameOnChange = exports.selectGameOnChange = function () {
	    var game, inputRecord, StoneGenerator;
	
	    var presetGtor = function (gameNum) {
	        return function () {
	            var index, game;
	            return index = 0, game = _fableCore.Seq.item(gameNum, _games.PresetGames.games), function (unitVar0) {
	    ...
	    var gameNum = strToInt(selectGame.value);
	    gameNum >= 0 ? (game = api.NewGame((inputRecord = config(), StoneGenerator = presetGtor(gameNum), new SameGameTypes.GameConfig(inputRecord.NumberOfColumns, inputRecord.NumberOfRows, StoneGenerator))), updateUi(game)) : null;
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	$export($export.P + $export.F, 'Function', {part: __webpack_require__(292)});
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	__webpack_require__(131)(Number, 'Number', function(iterated){
	  this._l = +iterated;
	  this._i = 0;
	}, function(){
	  var i    = this._i++
