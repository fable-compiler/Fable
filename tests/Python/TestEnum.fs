...
[<Fact>]
let ``test Enum operator lt-gt works`` () =
    let a = Fruits.Apple
    let b = Fruits.Banana
...
[<Fact>]
let ``test Enum operator lt works`` () =
    let a = Fruits.Apple
    let b = Fruits.Banana
...
[<Fact>]
let ``test Enum operator lt-eq works`` () =
    let a = Fruits.Apple
    let b = Fruits.Banana
...
[<Fact>]
let ``test Enum operator gt works`` () =
    let a = Fruits.Apple
    let b = Fruits.Banana
...
[<Fact>]
let ``test Enum operator gt-eq works`` () =
    let a = Fruits.Apple
    let b = Fruits.Banana
...
[<Fact>]
let ``test Non-scoped (in JS) variables with same name can be used`` () =
