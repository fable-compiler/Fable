...
[<Fact>]
let ``Seq.randomShuffleWith works`` () =
    let xs = seq { 1; 2; 3; 4; 5 }
...
[<Fact>]
let ``Seq.randomChoiceWith works`` () =
    let xs = seq { 10; 20; 30 }
    let rng = System.Random(42)
...
[<Fact>]
let ``Seq.randomChoicesWith works`` () =
    let xs = seq { 10; 20; 30 }
    let rng = System.Random(42)
...
[<Fact>]
let ``Seq.randomSampleWith works`` () =
    let xs = seq { 1; 2; 3; 4; 5 }
    let rng = System.Random(42)
