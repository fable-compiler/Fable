...
//     FableLibDir =
//         @$"{pwd}\fable_modules\fable-library.4.3.0"
//     FableModulesDir = @$"{pwd}\fable_modules"
//     References = []
...
let libKey = compiledFiles.Keys |> Seq.find (fun f -> f.EndsWith("Library.fs"))
