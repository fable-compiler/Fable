...
module React =
    ...
    and ReactElement<'P> =
        ...
        abstract ref: U2<string, obj> with get, set
    ...
    and [<Import("___React?get=Component<'P, 'S>")>] Component<'P, 'S> =
        ...
        abstract createNew: ?props: 'P * ?context: obj -> Component<'P, 'S>
    ...
    and Props<'T> =
        ...
        abstract ref: U2<string, obj> option with get, set
