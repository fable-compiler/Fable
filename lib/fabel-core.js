  ...
  F.Async = (function(){
    ...
    var Async = {
      ...
      combine: function(work1, work2) {
        return F.AsyncBuilder.bind(work1, function() {
          return work2;
        });
      },
      delay: function(cont) {
      ...
      for: function(seq, body) {
        var iter = seq[Symbol.iterator](),
            cur = iter.next();
        return F.AsyncBuilder.while(function() {
            return !cur.done;
          },
          F.AsyncBuilder.delay(function() {
      ...
      while: function(cond, body) {
        return cond()
        ? F.AsyncBuilder.bind(body, function() {
            F.AsyncBuilder.while(cond, body);
          })
        : F.AsyncBuilder.return();
      },
      zero: function() {
        return protectedCont(function(ctx) {
          ctx.onSuccess();
