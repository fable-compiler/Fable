...
module THREE =
   ...
   // custom blending src factors
    ...
    type Globals =
        member __.REVISION with get(): string = failwith "JS only" and set(v: string): unit = failwith "JS only"
        member __.CullFaceNone with get(): CullFace = failwith "JS only" and set(v: CullFace): unit = failwith "JS only"
        member __.CullFaceBack with get(): CullFace = failwith "JS only" and set(v: CullFace): unit = failwith "JS only"
        member __.CullFaceFront with get(): CullFace = failwith "JS only" and set(v: CullFace): unit = failwith "JS only"
        member __.CullFaceFrontBack with get(): CullFace = failwith "JS only" and set(v: CullFace): unit = failwith "JS only"
        member __.FrontFaceDirectionCW with get(): FrontFaceDirection = failwith "JS only" and set(v: FrontFaceDirection): unit = failwith "JS only"
        member __.FrontFaceDirectionCCW with get(): FrontFaceDirection = failwith "JS only" and set(v: FrontFaceDirection): unit = failwith "JS only"
        member __.BasicShadowMap with get(): ShadowMapType = failwith "JS only" and set(v: ShadowMapType): unit = failwith "JS only"
        member __.PCFShadowMap with get(): ShadowMapType = failwith "JS only" and set(v: ShadowMapType): unit = failwith "JS only"
        member __.PCFSoftShadowMap with get(): ShadowMapType = failwith "JS only" and set(v: ShadowMapType): unit = failwith "JS only"
        member __.FrontSide with get(): Side = failwith "JS only" and set(v: Side): unit = failwith "JS only"
        member __.BackSide with get(): Side = failwith "JS only" and set(v: Side): unit = failwith "JS only"
        member __.DoubleSide with get(): Side = failwith "JS only" and set(v: Side): unit = failwith "JS only"
        member __.FlatShading with get(): Shading = failwith "JS only" and set(v: Shading): unit = failwith "JS only"
        member __.SmoothShading with get(): Shading = failwith "JS only" and set(v: Shading): unit = failwith "JS only"
        member __.NoColors with get(): Colors = failwith "JS only" and set(v: Colors): unit = failwith "JS only"
        member __.FaceColors with get(): Colors = failwith "JS only" and set(v: Colors): unit = failwith "JS only"
        member __.VertexColors with get(): Colors = failwith "JS only" and set(v: Colors): unit = failwith "JS only"
        member __.NoBlending with get(): Blending = failwith "JS only" and set(v: Blending): unit = failwith "JS only"
        member __.NormalBlending with get(): Blending = failwith "JS only" and set(v: Blending): unit = failwith "JS only"
        member __.AdditiveBlending with get(): Blending = failwith "JS only" and set(v: Blending): unit = failwith "JS only"
        member __.SubtractiveBlending with get(): Blending = failwith "JS only" and set(v: Blending): unit = failwith "JS only"
        member __.MultiplyBlending with get(): Blending = failwith "JS only" and set(v: Blending): unit = failwith "JS only"
        member __.CustomBlending with get(): Blending = failwith "JS only" and set(v: Blending): unit = failwith "JS only"
        member __.AddEquation with get(): BlendingEquation = failwith "JS only" and set(v: BlendingEquation): unit = failwith "JS only"
        member __.SubtractEquation with get(): BlendingEquation = failwith "JS only" and set(v: BlendingEquation): unit = failwith "JS only"
        member __.ReverseSubtractEquation with get(): BlendingEquation = failwith "JS only" and set(v: BlendingEquation): unit = failwith "JS only"
        member __.MinEquation with get(): BlendingEquation = failwith "JS only" and set(v: BlendingEquation): unit = failwith "JS only"
        member __.MaxEquation with get(): BlendingEquation = failwith "JS only" and set(v: BlendingEquation): unit = failwith "JS only"
        member __.ZeroFactor with get(): BlendingDstFactor = failwith "JS only" and set(v: BlendingDstFactor): unit = failwith "JS only"
        member __.OneFactor with get(): BlendingDstFactor = failwith "JS only" and set(v: BlendingDstFactor): unit = failwith "JS only"
        member __.SrcColorFactor with get(): BlendingDstFactor = failwith "JS only" and set(v: BlendingDstFactor): unit = failwith "JS only"
        member __.OneMinusSrcColorFactor with get(): BlendingDstFactor = failwith "JS only" and set(v: BlendingDstFactor): unit = failwith "JS only"
        member __.SrcAlphaFactor with get(): BlendingDstFactor = failwith "JS only" and set(v: BlendingDstFactor): unit = failwith "JS only"
        member __.OneMinusSrcAlphaFactor with get(): BlendingDstFactor = failwith "JS only" and set(v: BlendingDstFactor): unit = failwith "JS only"
        member __.DstAlphaFactor with get(): BlendingDstFactor = failwith "JS only" and set(v: BlendingDstFactor): unit = failwith "JS only"
        member __.OneMinusDstAlphaFactor with get(): BlendingDstFactor = failwith "JS only" and set(v: BlendingDstFactor): unit = failwith "JS only"
        member __.DstColorFactor with get(): BlendingSrcFactor = failwith "JS only" and set(v: BlendingSrcFactor): unit = failwith "JS only"
        member __.OneMinusDstColorFactor with get(): BlendingSrcFactor = failwith "JS only" and set(v: BlendingSrcFactor): unit = failwith "JS only"
        member __.SrcAlphaSaturateFactor with get(): BlendingSrcFactor = failwith "JS only" and set(v: BlendingSrcFactor): unit = failwith "JS only"
        member __.NeverDepth with get(): DepthModes = failwith "JS only" and set(v: DepthModes): unit = failwith "JS only"
        member __.AlwaysDepth with get(): DepthModes = failwith "JS only" and set(v: DepthModes): unit = failwith "JS only"
        member __.LessDepth with get(): DepthModes = failwith "JS only" and set(v: DepthModes): unit = failwith "JS only"
        member __.LessEqualDepth with get(): DepthModes = failwith "JS only" and set(v: DepthModes): unit = failwith "JS only"
        member __.EqualDepth with get(): DepthModes = failwith "JS only" and set(v: DepthModes): unit = failwith "JS only"
        member __.GreaterEqualDepth with get(): DepthModes = failwith "JS only" and set(v: DepthModes): unit = failwith "JS only"
        member __.GreaterDepth with get(): DepthModes = failwith "JS only" and set(v: DepthModes): unit = failwith "JS only"
        member __.NotEqualDepth with get(): DepthModes = failwith "JS only" and set(v: DepthModes): unit = failwith "JS only"
        member __.MultiplyOperation with get(): Combine = failwith "JS only" and set(v: Combine): unit = failwith "JS only"
        member __.MixOperation with get(): Combine = failwith "JS only" and set(v: Combine): unit = failwith "JS only"
        member __.AddOperation with get(): Combine = failwith "JS only" and set(v: Combine): unit = failwith "JS only"
        member __.NoToneMapping with get(): ToneMapping = failwith "JS only" and set(v: ToneMapping): unit = failwith "JS only"
        member __.LinearToneMapping with get(): ToneMapping = failwith "JS only" and set(v: ToneMapping): unit = failwith "JS only"
        member __.ReinhardToneMapping with get(): ToneMapping = failwith "JS only" and set(v: ToneMapping): unit = failwith "JS only"
        member __.Uncharted2ToneMapping with get(): ToneMapping = failwith "JS only" and set(v: ToneMapping): unit = failwith "JS only"
        member __.CineonToneMapping with get(): ToneMapping = failwith "JS only" and set(v: ToneMapping): unit = failwith "JS only"
        member __.UVMapping with get(): Mapping = failwith "JS only" and set(v: Mapping): unit = failwith "JS only"
        member __.CubeReflectionMapping with get(): Mapping = failwith "JS only" and set(v: Mapping): unit = failwith "JS only"
        member __.CubeRefractionMapping with get(): Mapping = failwith "JS only" and set(v: Mapping): unit = failwith "JS only"
        member __.EquirectangularReflectionMapping with get(): Mapping = failwith "JS only" and set(v: Mapping): unit = failwith "JS only"
        member __.EquirectangularRefractionMapping with get(): Mapping = failwith "JS only" and set(v: Mapping): unit = failwith "JS only"
        member __.SphericalReflectionMapping with get(): Mapping = failwith "JS only" and set(v: Mapping): unit = failwith "JS only"
        member __.CubeUVReflectionMapping with get(): Mapping = failwith "JS only" and set(v: Mapping): unit = failwith "JS only"
        member __.CubeUVRefractionMapping with get(): Mapping = failwith "JS only" and set(v: Mapping): unit = failwith "JS only"
        member __.RepeatWrapping with get(): Wrapping = failwith "JS only" and set(v: Wrapping): unit = failwith "JS only"
        member __.ClampToEdgeWrapping with get(): Wrapping = failwith "JS only" and set(v: Wrapping): unit = failwith "JS only"
        member __.MirroredRepeatWrapping with get(): Wrapping = failwith "JS only" and set(v: Wrapping): unit = failwith "JS only"
        member __.NearestFilter with get(): TextureFilter = failwith "JS only" and set(v: TextureFilter): unit = failwith "JS only"
        member __.NearestMipMapNearestFilter with get(): TextureFilter = failwith "JS only" and set(v: TextureFilter): unit = failwith "JS only"
        member __.NearestMipMapLinearFilter with get(): TextureFilter = failwith "JS only" and set(v: TextureFilter): unit = failwith "JS only"
        member __.LinearFilter with get(): TextureFilter = failwith "JS only" and set(v: TextureFilter): unit = failwith "JS only"
        member __.LinearMipMapNearestFilter with get(): TextureFilter = failwith "JS only" and set(v: TextureFilter): unit = failwith "JS only"
        member __.LinearMipMapLinearFilter with get(): TextureFilter = failwith "JS only" and set(v: TextureFilter): unit = failwith "JS only"
        member __.UnsignedByteType with get(): TextureDataType = failwith "JS only" and set(v: TextureDataType): unit = failwith "JS only"
        member __.ByteType with get(): TextureDataType = failwith "JS only" and set(v: TextureDataType): unit = failwith "JS only"
        member __.ShortType with get(): TextureDataType = failwith "JS only" and set(v: TextureDataType): unit = failwith "JS only"
        member __.UnsignedShortType with get(): TextureDataType = failwith "JS only" and set(v: TextureDataType): unit = failwith "JS only"
        member __.IntType with get(): TextureDataType = failwith "JS only" and set(v: TextureDataType): unit = failwith "JS only"
        member __.UnsignedIntType with get(): TextureDataType = failwith "JS only" and set(v: TextureDataType): unit = failwith "JS only"
        member __.FloatType with get(): TextureDataType = failwith "JS only" and set(v: TextureDataType): unit = failwith "JS only"
        member __.HalfFloatType with get(): TextureDataType = failwith "JS only" and set(v: TextureDataType): unit = failwith "JS only"
        member __.UnsignedShort4444Type with get(): PixelType = failwith "JS only" and set(v: PixelType): unit = failwith "JS only"
        member __.UnsignedShort5551Type with get(): PixelType = failwith "JS only" and set(v: PixelType): unit = failwith "JS only"
        member __.UnsignedShort565Type with get(): PixelType = failwith "JS only" and set(v: PixelType): unit = failwith "JS only"
        member __.AlphaFormat with get(): PixelFormat = failwith "JS only" and set(v: PixelFormat): unit = failwith "JS only"
        member __.RGBFormat with get(): PixelFormat = failwith "JS only" and set(v: PixelFormat): unit = failwith "JS only"
        member __.RGBAFormat with get(): PixelFormat = failwith "JS only" and set(v: PixelFormat): unit = failwith "JS only"
        member __.LuminanceFormat with get(): PixelFormat = failwith "JS only" and set(v: PixelFormat): unit = failwith "JS only"
        member __.LuminanceAlphaFormat with get(): PixelFormat = failwith "JS only" and set(v: PixelFormat): unit = failwith "JS only"
        member __.RGBEFormat with get(): PixelFormat = failwith "JS only" and set(v: PixelFormat): unit = failwith "JS only"
        member __.RGB_S3TC_DXT1_Format with get(): CompressedPixelFormat = failwith "JS only" and set(v: CompressedPixelFormat): unit = failwith "JS only"
        member __.RGBA_S3TC_DXT1_Format with get(): CompressedPixelFormat = failwith "JS only" and set(v: CompressedPixelFormat): unit = failwith "JS only"
        member __.RGBA_S3TC_DXT3_Format with get(): CompressedPixelFormat = failwith "JS only" and set(v: CompressedPixelFormat): unit = failwith "JS only"
        member __.RGBA_S3TC_DXT5_Format with get(): CompressedPixelFormat = failwith "JS only" and set(v: CompressedPixelFormat): unit = failwith "JS only"
        member __.RGB_PVRTC_4BPPV1_Format with get(): CompressedPixelFormat = failwith "JS only" and set(v: CompressedPixelFormat): unit = failwith "JS only"
        member __.RGB_PVRTC_2BPPV1_Format with get(): CompressedPixelFormat = failwith "JS only" and set(v: CompressedPixelFormat): unit = failwith "JS only"
        member __.RGBA_PVRTC_4BPPV1_Format with get(): CompressedPixelFormat = failwith "JS only" and set(v: CompressedPixelFormat): unit = failwith "JS only"
        member __.RGBA_PVRTC_2BPPV1_Format with get(): CompressedPixelFormat = failwith "JS only" and set(v: CompressedPixelFormat): unit = failwith "JS only"
        member __.RGB_ETC1_Format with get(): CompressedPixelFormat = failwith "JS only" and set(v: CompressedPixelFormat): unit = failwith "JS only"
        member __.LoopOnce with get(): AnimationActionLoopStyles = failwith "JS only" and set(v: AnimationActionLoopStyles): unit = failwith "JS only"
        member __.LoopRepeat with get(): AnimationActionLoopStyles = failwith "JS only" and set(v: AnimationActionLoopStyles): unit = failwith "JS only"
        member __.LoopPingPong with get(): AnimationActionLoopStyles = failwith "JS only" and set(v: AnimationActionLoopStyles): unit = failwith "JS only"
        member __.InterpolateDiscrete with get(): InterpolationModes = failwith "JS only" and set(v: InterpolationModes): unit = failwith "JS only"
        member __.InterpolateLinear with get(): InterpolationModes = failwith "JS only" and set(v: InterpolationModes): unit = failwith "JS only"
        member __.InterpolateSmooth with get(): InterpolationModes = failwith "JS only" and set(v: InterpolationModes): unit = failwith "JS only"
        member __.ZeroCurvatureEnding with get(): InterpolationEndingModes = failwith "JS only" and set(v: InterpolationEndingModes): unit = failwith "JS only"
        member __.ZeroSlopeEnding with get(): InterpolationEndingModes = failwith "JS only" and set(v: InterpolationEndingModes): unit = failwith "JS only"
        member __.WrapAroundEnding with get(): InterpolationEndingModes = failwith "JS only" and set(v: InterpolationEndingModes): unit = failwith "JS only"
        member __.TrianglesDrawModesMode with get(): TrianglesDrawModes = failwith "JS only" and set(v: TrianglesDrawModes): unit = failwith "JS only"
        member __.TriangleStripDrawMode with get(): TrianglesDrawModes = failwith "JS only" and set(v: TrianglesDrawModes): unit = failwith "JS only"
        member __.TriangleFanDrawMode with get(): TrianglesDrawModes = failwith "JS only" and set(v: TrianglesDrawModes): unit = failwith "JS only"
        member __.LinearEncoding with get(): TextureEncoding = failwith "JS only" and set(v: TextureEncoding): unit = failwith "JS only"
        member __.sRGBEncoding with get(): TextureEncoding = failwith "JS only" and set(v: TextureEncoding): unit = failwith "JS only"
        member __.GammaEncoding with get(): TextureEncoding = failwith "JS only" and set(v: TextureEncoding): unit = failwith "JS only"
        member __.RGBEEncoding with get(): TextureEncoding = failwith "JS only" and set(v: TextureEncoding): unit = failwith "JS only"
        member __.LogLuvEncoding with get(): TextureEncoding = failwith "JS only" and set(v: TextureEncoding): unit = failwith "JS only"
        member __.RGBM7Encoding with get(): TextureEncoding = failwith "JS only" and set(v: TextureEncoding): unit = failwith "JS only"
        member __.RGBM16Encoding with get(): TextureEncoding = failwith "JS only" and set(v: TextureEncoding): unit = failwith "JS only"
        member __.RGBDEncoding with get(): TextureEncoding = failwith "JS only" and set(v: TextureEncoding): unit = failwith "JS only"
        member __.GeometryIdCount with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
        member __.Object3DIdCount with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
        member __.DefaultLoadingManager with get(): LoadingManager = failwith "JS only" and set(v: LoadingManager): unit = failwith "JS only"
        member __.MaterialIdCount with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
        member __.LineStrip with get(): LineMode = failwith "JS only" and set(v: LineMode): unit = failwith "JS only"
        member __.LinePieces with get(): LineMode = failwith "JS only" and set(v: LineMode): unit = failwith "JS only"
        member __.ShaderChunk with get(): ShaderChunkType = failwith "JS only" and set(v: ShaderChunkType): unit = failwith "JS only"
        member __.ShaderLib with get(): ShaderLibType = failwith "JS only" and set(v: ShaderLibType): unit = failwith "JS only"
        member __.UniformsLib with get(): UniformsLibType = failwith "JS only" and set(v: UniformsLibType): unit = failwith "JS only"
        member __.TextureIdCount with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
        member __.warn(message: obj, [<ParamArray>] optionalParams: obj[]): unit = failwith "JS only"
        member __.error(message: obj, [<ParamArray>] optionalParams: obj[]): unit = failwith "JS only"
        member __.log(message: obj, [<ParamArray>] optionalParams: obj[]): unit = failwith "JS only"

    module AnimationUtils =
        type Globals =
            member __.arraySlice(array: obj, from: float, ``to``: float): obj = failwith "JS only"
            member __.convertArray(array: obj, ``type``: obj, forceClone: bool): obj = failwith "JS only"
            member __.isTypedArray(``object``: obj): bool = failwith "JS only"
            member __.getKeyFrameOrder(times: float): ResizeArray<float> = failwith "JS only"
            member __.sortedArray(values: ResizeArray<obj>, stride: float, order: ResizeArray<float>): ResizeArray<obj> = failwith "JS only"
            member __.flattenJSON(jsonKeys: ResizeArray<string>, times: ResizeArray<obj>, values: ResizeArray<obj>, valuePropertyName: string): unit = failwith "JS only"

    let [<Import("AnimationUtils","three")>] AnimationUtils: AnimationUtils.Globals = failwith "JS only"
    ...
    module GeometryUtils =
        type Globals =
            member __.merge(goemetry1: obj, goemetry2: obj, ?materialIndexOffset: obj): obj = failwith "JS only"
            member __.center(geometry: obj): obj = failwith "JS only"

    let [<Import("GeometryUtils","three")>] GeometryUtils: GeometryUtils.Globals = failwith "JS only"

    module Cache =
        type Globals =
            member __.enabled with get(): bool = failwith "JS only" and set(v: bool): unit = failwith "JS only"
            member __.files with get(): obj = failwith "JS only" and set(v: obj): unit = failwith "JS only"
            member __.add(key: string, file: obj): unit = failwith "JS only"
            member __.get(key: string): obj = failwith "JS only"
            member __.remove(key: string): unit = failwith "JS only"
            member __.clear(): unit = failwith "JS only"
            
    let [<Import("Cache","three")>] Cache: Cache.Globals = failwith "JS only"

    module ColorKeywords =
        type Globals =
            member __.aliceblue with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.antiquewhite with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.aqua with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.aquamarine with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.azure with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.beige with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.bisque with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.black with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.blanchedalmond with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.blue with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.blueviolet with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.brown with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.burlywood with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.cadetblue with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.chartreuse with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.chocolate with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.coral with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.cornflowerblue with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.cornsilk with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.crimson with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.cyan with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.darkblue with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.darkcyan with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.darkgoldenrod with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.darkgray with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.darkgreen with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.darkgrey with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.darkkhaki with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.darkmagenta with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.darkolivegreen with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.darkorange with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.darkorchid with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.darkred with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.darksalmon with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.darkseagreen with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.darkslateblue with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.darkslategray with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.darkslategrey with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.darkturquoise with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.darkviolet with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.deeppink with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.deepskyblue with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.dimgray with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.dimgrey with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.dodgerblue with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.firebrick with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.floralwhite with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.forestgreen with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.fuchsia with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.gainsboro with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.ghostwhite with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.gold with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.goldenrod with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            ...
            member __.greenyellow with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.grey with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.honeydew with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.hotpink with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.indianred with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.indigo with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.ivory with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.khaki with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.lavender with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.lavenderblush with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.lawngreen with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.lemonchiffon with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.lightblue with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.lightcoral with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.lightcyan with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.lightgoldenrodyellow with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.lightgray with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.lightgreen with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.lightgrey with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.lightpink with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.lightsalmon with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.lightseagreen with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.lightskyblue with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.lightslategray with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.lightslategrey with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.lightsteelblue with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.lightyellow with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.lime with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.limegreen with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.linen with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.magenta with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.maroon with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.mediumaquamarine with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.mediumblue with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.mediumorchid with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.mediumpurple with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.mediumseagreen with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.mediumslateblue with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.mediumspringgreen with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.mediumturquoise with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.mediumvioletred with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.midnightblue with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.mintcream with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.mistyrose with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.moccasin with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.navajowhite with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.navy with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.oldlace with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.olive with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.olivedrab with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.orange with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.orangered with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.orchid with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.palegoldenrod with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.palegreen with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.paleturquoise with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.palevioletred with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.papayawhip with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.peachpuff with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.peru with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.pink with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.plum with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.powderblue with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.purple with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.red with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.rosybrown with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.royalblue with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.saddlebrown with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.salmon with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.sandybrown with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.seagreen with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.seashell with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.sienna with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.silver with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.skyblue with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.slateblue with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.slategray with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.slategrey with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.snow with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.springgreen with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.steelblue with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.tan with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.teal with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.thistle with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.tomato with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.turquoise with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.violet with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.wheat with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.white with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.whitesmoke with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.yellow with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"
            member __.yellowgreen with get(): float = failwith "JS only" and set(v: float): unit = failwith "JS only"

    let [<Import("ColorKeywords","three")>] ColorKeywords: ColorKeywords.Globals = failwith "JS only"

    module Math =
        type Globals =
            member __.generateUUID(): string = failwith "JS only"
            member __.clamp(value: float, min: float, max: float): float = failwith "JS only"
            member __.euclideanModulo(n: float, m: float): float = failwith "JS only"
            member __.mapLinear(x: float, a1: float, a2: float, b1: float, b2: float): float = failwith "JS only"
            member __.smoothstep(x: float, min: float, max: float): float = failwith "JS only"
            member __.smootherstep(x: float, min: float, max: float): float = failwith "JS only"
            member __.random16(): float = failwith "JS only"
            member __.randInt(low: float, high: float): float = failwith "JS only"
            member __.randFloat(low: float, high: float): float = failwith "JS only"
            member __.randFloatSpread(range: float): float = failwith "JS only"
            member __.degToRad(degrees: float): float = failwith "JS only"
            member __.radToDeg(radians: float): float = failwith "JS only"
            member __.isPowerOfTwo(value: float): bool = failwith "JS only"
            member __.nearestPowerOfTwo(value: float): float = failwith "JS only"
            member __.nextPowerOfTwo(value: float): float = failwith "JS only"

    let [<Import("Math","three")>] Math: Math.Globals = failwith "JS only"

    module UniformsUtils =
        type Globals =
            member __.merge(uniforms: ResizeArray<obj>): obj = failwith "JS only"
            member __.clone(uniforms_src: obj): obj = failwith "JS only"

    let [<Import("UniformsUtils","three")>] UniformsUtils: UniformsUtils.Globals = failwith "JS only"

    module CurveUtils =
        type Globals =
            member __.tangentQuadraticBezier(t: float, p0: float, p1: float, p2: float): float = failwith "JS only"
            member __.tangentCubicBezier(t: float, p0: float, p1: float, p2: float, p3: float): float = failwith "JS only"
            member __.tangentSpline(t: float, p0: float, p1: float, p2: float, p3: float): float = failwith "JS only"
            member __.interpolate(p0: float, p1: float, p2: float, p3: float, t: float): float = failwith "JS only"

    let [<Import("CurveUtils","three")>] CurveUtils: CurveUtils.Globals = failwith "JS only"

    module ImageUtils =
        type Globals =
            member __.crossOrigin with get(): string = failwith "JS only" and set(v: string): unit = failwith "JS only"
            member __.loadTexture(url: string, ?mapping: Mapping, ?onLoad: Func<Texture, unit>, ?onError: Func<string, unit>): Texture = failwith "JS only"
            member __.loadTextureCube(array: ResizeArray<string>, ?mapping: Mapping, ?onLoad: Func<Texture, unit>, ?onError: Func<string, unit>): Texture = failwith "JS only"

    let [<Import("ImageUtils","three")>] ImageUtils: ImageUtils.Globals = failwith "JS only"

    module SceneUtils =
        type Globals =
            member __.createMultiMaterialObject(geometry: Geometry, materials: ResizeArray<Material>): Object3D = failwith "JS only"
            member __.detach(child: Object3D, parent: Object3D, scene: Scene): unit = failwith "JS only"
            member __.attach(child: Object3D, scene: Scene, parent: Object3D): unit = failwith "JS only"

    let [<Import("SceneUtils","three")>] SceneUtils: SceneUtils.Globals = failwith "JS only"

    module ShapeUtils =
        type Globals =
            member __.area(contour: ResizeArray<float>): float = failwith "JS only"
            member __.triangulate(contour: ResizeArray<float>, indices: bool): ResizeArray<float> = failwith "JS only"
            member __.triangulateShape(contour: ResizeArray<float>, holes: ResizeArray<obj>): ResizeArray<float> = failwith "JS only"
            member __.isClockWise(pts: ResizeArray<float>): bool = failwith "JS only"
            member __.b2(t: float, p0: float, p1: float, p2: float): float = failwith "JS only"
            member __.b3(t: float, p0: float, p1: float, p2: float, p3: float): float = failwith "JS only"

    let [<Import("ShapeUtils","three")>] ShapeUtils: ShapeUtils.Globals = failwith "JS only"

[<AutoOpen>]
module three_Extensions =
    let [<Import("*","three")>] three: THREE.Globals = failwith "JS only"
