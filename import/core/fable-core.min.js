...
},n)})};var m=function(){};m.prototype.add=function(n){var t={value:n};this.firstAndLast?(this.firstAndLast[1].next=t,this.firstAndLast=[this.firstAndLast[0],t]):this.firstAndLast=[t,t]},m.prototype.tryGet=function(n){if(this.firstAndLast){var t=this.firstAndLast[0].value;return this.firstAndLast[0].next?this.firstAndLast=[this.firstAndLast[0].next,this.firstAndLast[1]]:delete this.firstAndLast,t}};var v=n.MailboxProcessor=function(n){this.body=n,this.messages=new m};v.prototype.__processEvents=function(){if(this.continuation){var n=this.messages.tryGet();if(n){var t=this.continuation;delete this.continuation,t(n)}}},v.prototype.start=function(){y.startImmediate(this.body(this))},v.start=function(n){var t=new v(n);return t.start(),t},v.prototype.receive=function(){var n=this;return y.fromContinuations(function(t){if(n.continuation)throw"Receive can only be called once!";n.continuation=t[0],n.__processEvents()})},v.prototype.postAndAsyncReply=function(n){function t(){e&&r&&r(e)}var e,r,o={reply:function(n){e=n,t()}};return this.messages.add(n(o)),this.__processEvents(),y.fromContinuations(function(n){r=n[0],t()})},v.prototype.post=function(n){this.messages.add(n),this.__processEvents()};var h=function(n,t,e){this.onNext=n,this.onError=t||function(n){},this.onCompleted=e||function(){}};r.setInterfaces(h.prototype,["System.IObserver"]);var g=function(n){this.subscribe=n};r.setInterfaces(g.prototype,["System.IObservable"]);var b={};n.Observable=b,b.__protect=function(n,t,e){try{t(n())}catch(r){e(r)}},b.map=function(n,t){return new g(function(e){return t.subscribe(new h(function(t){b.__protect(function(){n(t)},e.onNext,e.onError)},e.onError,e.onCompleted))})},b.choose=function(n,t){return new g(function(e){return t.subscribe(new h(function(t){b.__protect(function(){n(t)},function(n){null!=n&&e.onNext(n)},e.onError)},e.onError,e.onCompleted))})},b.filter=function(n,t){return b.choose(function(t){return n(t)?t:null},t)},b.partition=function(n,t){return[b.filter(n,t),b.filter(function(t){return!n(t)},t)]},b.scan=function(n,t,e){return new g(function(r){return e.subscribe(new h(function(e){b.__protect(function(){n(t,e)},function(n){t=n,r.onNext(n)},r.onError)},r.onError,r.onCompleted))})},b.add=function(n,t){t.subscribe(new h(n))},b.subscribe=function(n,t){return t.subscribe(new h(n))},b.pairwise=function(n){return new g(function(t){var e=null;return n.subscribe(new h(function(n){null!=e&&t.onNext([e,n]),e=n},t.onError,t.onCompleted))})},b.merge=function(n,e){return new g(function(r){var o=!1,u=!1,i=!1,a=n.subscribe(new h(function(n){o||r.onNext(n)},function(n){o||(o=!0,r.onError(n))},function(){o||(u=!0,i&&(o=!0,r.onCompleted()))})),c=e.subscribe(new h(function(n){o||r.onNext(n)},function(n){o||(o=!0,r.onError(n))},function(){o||(i=!0,u&&(o=!0,r.onCompleted()))})),f={dispose:function(){a.dispose(),c.dispose()}};return f[t.interfaces]=["System.IDisposable"],f})},b.split=function(n,t){return[b.choose(function(t){var e=n(t);return"Choice1Of2"==e.Case?e.Fields[0]:null},t),b.choose(function(t){var e=n(t);return"Choice2Of2"==e.Case?e.Fields[0]:null},t)]};var w=n.Event=function(n,e){var r=this;this.delegates=e||new Array,this.trigger=function(n){l.iter(function(t){t(n)},r.delegates)};var o=function(n){r.delegates.push(n)},u=function(n){var t=function(t,e,r){return""+t==""+n},e=r.delegates.findIndex(t);e>-1&&r.delegates.splice(e,1)};this.subscribe=function(n){var e;return o(n),e={dispose:function(){u(n)}},e[t.interfaces]=["System.IDisposable"],e},this.add=function(n){o(n)},this.addHandler=function(n){var t=function(t){return n(void 0,t)};o(t)},this.removeHandler=function(n){var t=function(t){return n(void 0,t)};u(t)},this._subscribe=n||function(n){var e,r=n.onNext;return o(r),e={dispose:function(){u(r)}},e[t.interfaces]=["System.IDisposable"],e}};Object.defineProperty(w.prototype,"publish",{get:function(){return this}}),w.add=function(n,t){t._subscribe(new h(n))},w.map=function(n,t){var e=function(e){t._subscribe(new h(function(t){b.__protect(function(){return n(t)},e.onNext,e.onError)},e.onError,e.onCompleted))};return new w(e,t.delegates)},w.choose=function(n,t){var e=function(e){return t._subscribe(new h(function(t){b.__protect(function(){return n(t)},function(n){null!=n&&e.onNext(n)},e.onError)},e.onError,e.onCompleted))};return new w(e,t.delegates)},w.filter=function(n,t){return w.choose(function(t){return n(t)?t:null},t)},w.partition=function(n,t){return[w.filter(n,t),w.filter(function(t){return!n(t)},t)]},w.scan=function(n,t,e){var r=function(r){return e._subscribe(new h(function(e){b.__protect(function(){return n(t,e)},function(n){t=n,r.onNext(n)},r.onError)},r.onError,r.onCompleted))};return new w(r,e.delegates)},w.pairwise=function(n){var t=function(t){var e=null;return n._subscribe(new h(function(n){null!=e&&t.onNext([e,n]),e=n},t.onError,t.onCompleted))};return new w(t,n.delegates)},w.merge=function(n,e){var r=function(r){var o=!1,u=!1,i=!1,a=n._subscribe(new h(function(n){o||r.onNext(n)},function(n){o||(o=!0,r.onError(n))},function(){o||(u=!0,i&&(o=!0,r.onCompleted()))})),c=e._subscribe(new h(function(n){o||r.onNext(n)},function(n){o||(o=!0,r.onError(n))},function(){o||(i=!0,u&&(o=!0,r.onCompleted()))})),f={dispose:function(){a.dispose(),c.dispose()}};return f[t.interfaces]=["System.IDisposable"],f};return new w(r,n.delegates.concat(e.delegates))},w.split=function(n,t){return[w.choose(function(t){var e=n(t);return"Choice1Of2"==e.Case?e.Fields[0]:null},t),w.choose(function(t){var e=n(t);return"Choice2Of2"==e.Case?e.Fields[0]:null},t)]}});