...
export var Choice = function Choice(t, d) {
  this.Case = t;
  this.Fields = [d];
};
...
export var Timer = function Timer(interval) {
...
FString.split = function (str, splitters, count, removeEmpty) {
  ...
  splitters = splitters.filter(function(x){return x}).map(function(x){return FRegExp.escape(x)});
  splitters = splitters.length > 0 ? splitters : [" "];
  var m, i = 0, splits = [], reg = new RegExp(splitters.join("|"), "g");
...
export var Event = function (sbscrb, delegates) {
  var _this = this;
