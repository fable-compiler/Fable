...
module ReactNative =
    ...
    type Globals =
        [<Import("Promise", "react-native")>] static member Promise with get(): PromiseConstructor = failwith "JS only" and set(v: PromiseConstructor): unit = failwith "JS only"
        ...
        [<Import("SegmentedControlIOS", "react-native")>] static member SegmentedControlIOS with get(): React.ComponentClass<SegmentedControlIOSProperties> = failwith "JS only" and set(v: React.ComponentClass<SegmentedControlIOSProperties>): unit = failwith "JS only"
