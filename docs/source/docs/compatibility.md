...
delegate, this will be done automatically by the compiler. See [Calling F# code from JS](http://fable-compiler.github.io/docs/interacting.html#Calling-F-code-from-JavaScript)
for more info.
